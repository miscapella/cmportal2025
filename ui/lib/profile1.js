...
$(document).ready(function () {
    ...
    updateDiv('supplier/activity',_url,cid,cb);
    $("#summary").click(function (e) {
        ...
        updateDiv('supplier/summary',_url,cid,cb);
    });
    ...
    $("#invoices").click(function (e) {
        ...
        updateDiv('supplier/invoices',_url,cid,cb);
    });
    ...
    $("#transactions").click(function (e) {
        ...
        updateDiv('supplier/transactions',_url,cid,cb);
    });
    ...
    $("#email").click(function (e) {
        ...
        updateDiv('supplier/email',_url,cid,cb);
    ...
    $("#edit").click(function (e) {
        ...
        updateDiv('supplier/edit',_url,cid,cb);
    });
    ...
    $("#more").click(function (e) {
        ...
        updateDiv('supplier/more',_url,cid,cb);
    });
...
var sysrender = $('#sysfrm_ajaxrender');
    sysrender.on('click', '#acf-post', function(e){
        ...
        $('#ibox_form').block({ message: null });
        var _url = $("#_url").val();
        $.post(_url + 'supplier/add-activity-post/', {
            ...
            .done(function (data) {
                ...
                setTimeout(function () {
                    ...
                    if ($.isNumeric(data)) {
                        ...
                        window.location = _url + 'supplier/view/' + data + '/';
                    }
                    else {
                        $('#ibox_form').unblock();
    ...
    sysrender.on('click', '#submit', function(e){
        ...
        $('#ibox_form').block({ message: null });
        var _url = $("#_url").val();
        $.post(_url + 'supplier/edit-post/', $( "#rform" ).serialize())
            .done(function (data) {
