...
$(document).ready(function () {
	...
	if($("#lewati_gaji_pokok").prop("checked")) {
		$(".gaji-pokok").hide();
	}
	...
	if($("#skip_basic_salary").prop("checked")) {
		$(".basic-salary").hide();
	}
...
//			dataType: 'json',
			...
			success: function(data, textStatus, jqXHR)
			{
				...
				if ($.isNumeric(data)) {
					...
					window.location = _url + 'karyawan/list/Karyawan Berhasil Diedit !';
				}
				else {
					...
					$("#emsgbody").html(data);
					$("#emsg").show("slow");
					$('#position_title').attr('disabled', true);
				}
			},
	...
	$("#first_name").on("change", function (e) {
        $("#employee_name").val(($("#first_name").val() + " " + $("#middle_name").val() + " " + $("#last_name").val()).replace(/\s+/g, ' '));
    });

    $("#middle_name").on("change", function (e) {
        $("#employee_name").val(($("#first_name").val() + " " + $("#middle_name").val() + " " + $("#last_name").val()).replace(/\s+/g, ' '));
    });
	...
	$("#skip_basic_salary").click(function () {
        $(this).context.checked ? $(".basic-salary").hide() : $(".basic-salary").show();
    });
});