$(document).ready(function () {
    ...
    $('#administrator-list-mintabarang-pending').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/administrator-list-mintabarang-pending/",
			'type' : 'POST',
		},
    });

    $('#dept-list-mintabarang-pending').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/dept-list-mintabarang-pending/",
			'type' : 'POST',
		},
    });

    $('#service-head-list-mintabarang-pending').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/service-head-list-mintabarang-pending/",
			'type' : 'POST',
		},
    });

    $('#gaadmin-list-mintabarang-pending').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/gaadmin-list-mintabarang-pending/",
			'type' : 'POST',
		},
    });
