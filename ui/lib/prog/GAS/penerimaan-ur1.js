$(document).on("click", "#receive", function (e) {
    ...
    bootbox.confirm(
      "Apakah anda yakin untuk menerima UR ini ?",
      function (result) {
        if (result) {
          var idjs = $("#idtpl").val();
          var _url = $("#_url").val();
          ...
          $.ajax({
            url: _url + "persetujuan/penerimaan-ur1-aprv/",
            type: "POST",
            data: $data,
            cache: false,
            processData: false,
            ...
            success: function (data, textStatus, jqXHR) {
              ...
              if ($.isNumeric(obj.dataval)) {
                ...
                bootbox.alert({
                  ...
                  timeout: 2000,
                  callback: function () {
                    window.location = _url + "persetujuan/penerimaan-ur/";
                  },
                });
              } else {
  ...
  $(document).on("click", "#reject", function (e) {
    ...
    bootbox.confirm("Apakah anda yakin untuk reject PR ini ?", function (result) {
      if (result) {
        ...
        $.ajax({
          url: _url + "persetujuan/penerimaan-ur1-reject/",
          type: "POST",
          data: $data,
          cache: false,
          processData: false,
