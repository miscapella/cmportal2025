$(document).ready(function () {
    ...
    $('#list-mintabarang-cancelled').DataTable({
        "order": [2, 'desc'],
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/list-mintabarang-cancelled/",
			'type' : 'POST',
		},
    });

    $('#administrator-list-mintabarang-cancelled').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/administrator-list-mintabarang-cancelled/",
			'type' : 'POST',
		},
    });

    $('#dept-list-mintabarang-cancelled').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/dept-list-mintabarang-cancelled/",
			'type' : 'POST',
		},
    });

    $('#service-head-list-mintabarang-cancelled').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/service-head-list-mintabarang-cancelled/",
			'type' : 'POST',
		},
    });

    $('#gaadmin-list-mintabarang-cancelled').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/gaadmin-list-mintabarang-cancelled/",
			'type' : 'POST',
		},
    });
