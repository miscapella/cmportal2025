$(document).ready(function () {
    ...
    $('#add').on('click', function(){
		...
		// .done(function (data) {
            ...
            clist += '<td><input type="text" name="status[]" value="Pending" readonly></td>';
...
//        bootbox.confirm('yakin untuk menghapus data?', function(result) {
//           if(result){
...
//                    });
//                } else {
//                    $.post(_url + 'inventaris/hapus-itemstock/', {
//                        kode: kode,
...
//                        } else {
//                            bootbox.alert({
//                                message: 'Kesalahan dalam menghapus data Inventaris - Item Stock',
//                                backdrop: true,
//                                timeout : 2000,
//                                callback: function(){ 
...
//    });
	...
	$("#save").click(function (e) {
		...
		$.ajax({
			url: _url + 'inventaris/itemstock-post/',
			type: 'POST',
			data: $data,
			cache: false,
			//dataType: 'json',
