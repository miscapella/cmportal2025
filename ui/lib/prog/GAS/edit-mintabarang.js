$(document).ready(function () {
	...
	$(document).on('click', '#submitAddMintaBarang', function(e) {
		...
		if(error != ''){
			...
			clist += '<td><input type="text" name="keperluan[]" class="keperluan" value="'+ keperluan +'" style="border: none; background: transparent; cursor: default;" readonly></td>';
			...
			clist += '<td><input type="text" name="namabarang[]" class="namabarang" value="'+ namabarang +'" style="border: none; background: transparent; cursor: default;" readonly></td>';
			clist += '<td><input type="text" name="qty[]" class="qty" value='+ qty +' style="border: none; background: transparent; cursor: default;" readonly></td>';
			clist += '<td><input type="text" name="diperlukan[]" class="diperlukan tgl" value="'+ diperlukan +'" style="border: none; background: transparent; cursor: default;" readonly></td>';
			clist += '<td><input type="text" name="keterangan[]" class="keterangan" value="'+ keterangan +'" style="border: none; background: transparent; cursor: default;" readonly></td>';
	...
	$("#submit").click(function (e) {
		...
		// else {
			...
			bootbox.confirm('Apakah anda yakin untuk mengubah Permintaan Barang ?', function(result) {
				if(result){
					bootbox.dialog({
						message: '<div class="text-center"><i class="fas fa-spinfa-spinner"></i> Loading...</div>',
						closeButton: false
						...
						success: function(data, textStatus, jqXHR)
						{
							...
							if ($.isNumeric(obj.dataval)) {
								...
								bootbox.alert({
									...
									timeout : 2000,
									callback: function(){
										window.location = _url + 'permintaanbarang/list-mintabarang/Permintaan Barang Berhasil Diedit !';
									}
								});
							} else {
								$('#submit').removeAttr('disabled');
