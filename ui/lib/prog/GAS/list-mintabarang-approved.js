$(document).ready(function () {
    ...
    $('#administrator-list-mintabarang-approved').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/administrator-list-mintabarang-approved/",
			'type' : 'POST',
		},
    });

    $('#dept-list-mintabarang-approved').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/dept-list-mintabarang-approved/",
			'type' : 'POST',
		},
    });

    $('#service-head-list-mintabarang-approved').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/service-head-list-mintabarang-approved/",
			'type' : 'POST',
		},
    });

    $('#gaadmin-list-mintabarang-approved').DataTable({
        "order": [2, 'desc'],
        "pagingType": "full_numbers",
		"pageLength": 25,
		"scrollX": true,
		...
		"serverSide" : true,
        "ajax": {
			'url' : _url + "serverside/gaadmin-list-mintabarang-approved/",
			'type' : 'POST',
		},
    });
