$(document).ready(function () {
  ...
  $("#datatable").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: _url + "serverside/load-komponen/",
      type: "POST",
      data: function (d) {
    ...
    $.ajax({
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        if ($.isNumeric(data)) {
          window.location =
            _url +
            `inventaris/detail-item/${id_inventaris}/${id_item}/Detail Perbaikan Berhasil Diinput!`;
          // Clear Inputs
    ...
    $.ajax({
      ...
      success: function (data, textStatus, jqXHR) {
        ...
        if ($.isNumeric(data)) {
          window.location =
            _url +
            `inventaris/detail-item/${id_inventaris}/${id_item}/Detail Pergantian Barang Berhasil Diinput!`;
          // Clear Inputs
