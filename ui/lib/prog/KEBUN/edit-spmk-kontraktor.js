$(document).ready(function () {
  ...
  $("#save").click(function (e) {
    ...
    bootbox.confirm("Apakah anda yakin untuk mengubah SPmK ?", function (result) {
      if (result) {
        bootbox.dialog({
          message:
            '<div class="text-center"><i class="fas fa-spinfa-spinner"></i> Loading...</div>',
        ...
        $.ajax({
          url: _url + "pembelian/edit-spmk-kontraktor-post/",
          type: "POST",
          data: $data,
          cache: false,
          processData: false,
            ...
            if ($.isNumeric(obj.dataval)) {
              ...
              bootbox.alert({
                ...
                callback: function () {
                  window.location =
                    _url +
                    "pembelian/list-spmk-pending/SPmK Biding Berhasil Diubah";
                },
              });
            } else {
