$(document).ready(function () {
    ...
    sysrender.on('click', '#mail_quote_created', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=quotes/mail_invoice_/' + iid + '/created', '', function(){
                $modal.modal();
                $('.sysedit').summernote({
    ...
    $("#convert_invoice").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                ...
                var iid = $("#iid").val();
                $.post( "?ng=quotes/convert_invoice/", { iid: iid })
                    .done(function( data ) {
                       // console.log(data);
                        $('#ibox').unblock();
    ...
    $("#mark_draft").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=quotes/mark_draft/", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_delivered").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=quotes/mark_delivered/", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_on_hold").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=quotes/mark_on_hold/", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_accepted").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=quotes/mark_accepted/", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_lost").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=quotes/mark_lost/", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_dead").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=quotes/mark_dead/", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
