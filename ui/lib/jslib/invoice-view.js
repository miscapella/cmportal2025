$(document).ready(function () {
    ...
    sysrender.on('click', '#add_payment', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=invoices/add-payment/' + iid, '', function(){
                $modal.modal();
    ...
    sysrender.on('click', '#mail_invoice_created', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=invoices/mail_invoice_/' + iid + '/created', '', function(){
                $modal.modal();
                $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_reminder', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=invoices/mail_invoice_/' + iid + '/reminder', '', function(){
                $modal.modal();
                $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_overdue', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=invoices/mail_invoice_/' + iid + '/overdue', '', function(){
                $modal.modal();
                $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_confirm', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=invoices/mail_invoice_/' + iid + '/confirm', '', function(){
                $modal.modal();
                $('.sysedit').summernote({
    ...
    sysrender.on('click', '#mail_invoice_refund', function(e){
        ...
        setTimeout(function(){
            $modal.load('?ng=invoices/mail_invoice_/' + iid + '/refund', '', function(){
                $modal.modal();
                $('.sysedit').summernote({
    ...
    $("#mark_paid").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=invoices/markpaid", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_unpaid").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
           if(result){
               var iid = $("#iid").val();
               $.post( "?ng=invoices/markunpaid", { iid: iid })
                   .done(function( data ) {
                       location.reload();
                   });
           }
    ...
    $("#mark_cancelled").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=invoices/markcancelled", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
    ...
    $("#mark_partially_paid").click(function (e) {
        ...
        bootbox.confirm($("#_lan_msg_confirm").val(), function(result) {
            if(result){
                var iid = $("#iid").val();
                $.post( "?ng=invoices/markpartiallypaid", { iid: iid })
                    .done(function( data ) {
                        location.reload();
                    });
            }
