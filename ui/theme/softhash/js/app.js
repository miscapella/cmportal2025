$(document).ready(function () {
    ...
    $('.navbar-minimalize').click(function () {
        if($(".navbar-header i").hasClass('fa fa-indent')) {
			$('.navbar-header i').removeClass('fa fa-indent');
			$('.navbar-header i').toggleClass('fa fa-outdent');
			$("body").toggleClass("mini-navbar");
		} else {
			$('.navbar-header i').removeClass('fa fa-outdent');
			$('.navbar-header i').toggleClass('fa fa-indent');
			$("body").toggleClass("mini-navbar");
		}
		$.post(_url + 'render/minibar/', {
		})
		.done(function (data) {
		});
		SmoothlyMenu();
