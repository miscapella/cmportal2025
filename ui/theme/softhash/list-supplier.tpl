    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form class="form-horizontal" method="post" action="{$_url}supplier/list/">
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <a href="{$_url}supplier/add/" class="btn btn-success btn-block"><i class="fa fa-plus"></i> Tambah Supplier Baru</a>
...
<h3>{$_L['Filter by Tags']}</h3>
                <ul class="tag-list" style="padding: 0">
                 {foreach $t as $ts}
                     <li><a href="{$_url}supplier/list/{$ts['account']}/"><i class="fa fa-tag"></i> {$ts['account']}</a></li>
                 {/foreach}
                </ul>
            </div>
        </div>
...
<div class="row">
    ...
    {if ($_c['supplier_set_view_mode']) eq 'tbl'}
                ...
                <table class="table table-bordered table-hover sys_table">
                    ...
                    {foreach $d as $ds}
                        ...
                        <tr>
                            ...
                            <td><a href="{$_url}supplier/view/{$ds['id']}/">{$nourut}</a> </td>

                            <td><a href="{$_url}supplier/view/{$ds['id']}/">{$ds['account']}</a> </td>
                            <td>{$ds['company']}</td>
                            ...
                            <td class="text-right">
                                <a href="{$_url}supplier/view/{$ds['id']}/" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> {$_L['View']}</a>
                    ...
                    <div class="panel-body">
                        <div class="contact-info">
                            ...
                            <p>
                                ...
                                <a href="delete/supp-user/{$ds['id']}/" class="btn btn-danger btn-xs cdelete" id="uid{$ds['id']}"><i class="fa fa-trash"></i> {$_L['Delete']}</a>
                            </p>
                        </div>
                    </div>
                </div>
