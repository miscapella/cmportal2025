                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li class="{if $_sysfrm_menu eq 'data'}mm-active{/if}">
                        ...
                        <ul class="nav-second-level">
                            <li class="{if $_sysfrm_menu2 eq 'listpenerimaan'}mm-active{/if}"><a href="{$_url}penerimaan/list/">Penerimaan Unit</a></li>
							<li class="{if $_sysfrm_menu2 eq 'historypenerimaan'}mm-active{/if}"><a href="{$_url}penerimaan/history/">History Penerimaan</a></li>
                            <li class="{if $_sysfrm_menu2 eq 'listmutasi'}mm-active{/if}"><a href="{$_url}mutasi/list/">Mutasi Mobil</a></li> 
                            <li class="{if $_sysfrm_menu2 eq 'listbatalkonfirmasimutasi'}mm-active{/if}"><a href="{$_url}mutasi/list-batal-konfirmasi-mutasi/">Batal Konfirmasi Mutasi</a></li>   
                    ...
                    <li class="{if $_sysfrm_menu eq 'reports'}mm-active{/if}">
						...
						<ul class="nav-second-level">
							<li class="{if $_sysfrm_menu2 eq 'laporangudang'}mm-active{/if}"><a href="{$_url}laporan/gudang/">Laporan Stock Gudang</a></li> 
							<li class="{if $_sysfrm_menu2 eq 'laporanintransit'}mm-active{/if}"><a href="{$_url}laporan/intransit/">Laporan Stock Intransit</a></li> 
						</ul>
					</li>
                </ul>
            </div>
