      ...
      <nav class="sidebar-nav navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
          <ul class="metismenu" id="side-menu">
            ...
            <li {if $_sysfrm_menu eq 'dashboard' }class="mm-active" {/if}><a href="{$_url}{$_c['redirect_url']}/"><i
            ...
            <li class="{if $_sysfrm_menu eq 'data'}mm-active{/if}">
              ...
              <ul class="nav-second-level">
                <li class="{if $_sysfrm_menu1 eq 'listinventaris'}mm-active{/if}"><a href="{$_url}inventaris/list/"><i class="fa fa-archive"></i> Daftar
                    Inventaris</a></li>
                    <li class="{if $_sysfrm_menu1 eq 'listbelumcetakqr'}mm-active{/if}"><a href="{$_url}cetak/list/"><i class="fa fa-qrcode"></i> Cetak
                        QR</a></li>
              </ul>
            </li>
          </ul>
...
-->
              ...
              <li class="dropdown navbar-user">
                ...
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                  ...
                  <img src="http://www.gravatar.com/avatar/{($user['username'])|md5}?s=200" class="img-circle"
                    alt="{$user['fullname']}">
                  {elseif $user['img'] eq ''}
        ...
        <div class="row wrapper white-bg page-heading">
          <div class="col-lg-12">
            <h2 style="color: #2F4050; font-size: 16px; font-weight: 400; margin-top: 18px"><b>{$ncomp}</b> - {$_st}
            </h2>
