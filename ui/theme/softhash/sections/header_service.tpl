            ...
            <nav class="sidebar-nav navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="metismenu" id="side-menu">
                        ...
                        {if _auth2('SHOW-MASTERDATA-CUSTOMER', $user['id']) || _auth2('SHOW-MASTERDATA-POSISI', $user['id'])}
                        <li class="{if $_sysfrm_menu eq 'masterdata'}mm-active{/if}">
                            ...
                            <ul class="nav-second-level">
                                {if _auth2('SHOW-MASTERDATA-CUSTOMER', $user['id'])}
                                <li class="{if $_sysfrm_menu1 eq 'customer-list'}mm-active{/if}"><a href="{$_url}customer/list/">List Customer</a></li>
                                {/if}
                                {if _auth2('SHOW-MASTERDATA-TIPE-KENDARAAN', $user['id'])}
                                <li class="{if $_sysfrm_menu1 eq 'tipe-kendaraan-list'}mm-active{/if}"><a href="{$_url}tipe-kendaraan/list/">List Tipe Kendaraan</a></li>
                                {/if}
                        ...
                        {if _auth2('SHOW-GRAFIK-CUSTOMER', $user['id']) || _auth2('SHOW-PRODUKTIVITAS-BENGKEL', $user['id']) || _auth2('SHOW-PRODUKTIVITAS-MARKETING', $user['id']) || _auth2('SHOW-LAPORAN-SERVICE', $user['id'])}
                        <li class="{if $_sysfrm_menu eq 'analisis'}mm-active{/if}">
                            ...
                            <ul class="nav-second-level">
                                {if _auth2('SHOW-GRAFIK-CUSTOMER', $user['id'])}
                                <li class="{if $_sysfrm_menu1 eq 'grafik-customer'}mm-active{/if}">
                                    <a href="#" class="has-arrow">Grafik Customer</a>
                                    <ul class="nav-third-level">
                                        <li class="{if $_sysfrm_menu2 eq 'profil-distribusi-customer'}mm-active{/if}"><a href="{$_url}grafik-customer/profil-distribusi-customer/">Profil Distribusi Customer</a></li>
                                        <!-- <li class="{if $_sysfrm_menu2 eq 'rekapitulasi-cuti-customer'}mm-active{/if}"><a href="{$_url}grafik-customer/rekapitulasi-cuti-customer/">Rekapitulasi Cuti Customer</a></li> -->
                                        <!-- <li class="{if $_sysfrm_menu2 eq 'demografi-customer'}mm-active{/if}"><a href="{$_url}grafik-customer/demografi-customer/">Demografi Customer</a></li> -->
                                        <!-- <li class="{if $_sysfrm_menu2 eq 'status-customer'}mm-active{/if}"><a href="{$_url}grafik-customer/status-customer/">Status Customer</a></li> -->
                                        <!-- <li class="{if $_sysfrm_menu2 eq 'pendidikan-customer'}mm-active{/if}"><a href="{$_url}grafik-customer/pendidikan-customer/">Pendidikan Customer</a></li> -->
                                        <!-- <li class="{if $_sysfrm_menu2 eq 'terminated-customer'}mm-active{/if}"><a href="{$_url}grafik-customer/terminated-customer/">Terminated Customer</a></li> -->
                                        <!-- <li class="{if $_sysfrm_menu2 eq 'bpjs-kesehatan'}mm-active{/if}"><a href="{$_url}grafik-customer/bpjs-kesehatan/">BPJS Kesehatan</a></li> -->
                                    </ul>
                                </li>
                                {/if}
                                {if _auth2('SHOW-LAPORAN-SERVICE', $user['id'])}
                                <li class="{if $_sysfrm_menu1 eq 'laporan-service'}mm-active{/if}"><a href="{$_url}laporan-service/">Laporan</a></li>
                                {/if}
