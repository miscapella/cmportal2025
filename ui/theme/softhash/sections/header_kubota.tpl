...
<head>
    ...
    <link href="{$_theme}/css/style.css?ver=2.0.2" rel="stylesheet">
                ...
                <ul class="metismenu" id="side-menu">
                    ...
                    <li class="{if $_sysfrm_menu eq 'data'}mm-active{/if}">
                        ...
                        <ul class="nav-second-level">
							<li class="{if $_sysfrm_menu1 eq 'contact'}mm-active{/if}">
								<a class="has-arrow" href="#"><i class="fa fa-user"></i> Customer</a>
								<ul class="nav-third-level">
									<li class="{if $_sysfrm_menu2 eq 'addcontact'}mm-active{/if}"><a href="{$_url}contacts/add/">{$_L['Add Contact']}</a></li>
									<li class="{if $_sysfrm_menu2 eq 'listcontact'}mm-active{/if}"><a href="{$_url}contacts/list/">{$_L['List Contacts']}</a></li>
								</ul>
							</li>
							<li class="{if $_sysfrm_menu1 eq 'formstock'}mm-active{/if}">
								<a class="has-arrow" href="#"><i class="fa fa-cubes"></i> Form Stock</a>
								<ul class="nav-third-level">
									<li class="{if $_sysfrm_menu2 eq 'form-list'}mm-active{/if}"><a href="{$_url}formstock/list/">Daftar Form</a></li>
									<li class="{if $_sysfrm_menu2 eq 'form-add'}mm-active{/if}"><a href="{$_url}formstock/add/">Tambah Form</a></li>
								</ul>
							</li>
						</ul>
					</li>
					...
					<li class="{if $_sysfrm_menu eq 'transaksi'}mm-active{/if}">
						...
						<ul class="nav-second-level">
							<li class="{if $_sysfrm_menu1 eq 'pesanan'}mm-active{/if}">
								<a class="has-arrow" href="#"><i class="fa fa-user"></i> Pesanan</a>
								<ul class="nav-third-level">
									<li class="{if $_sysfrm_menu2 eq 'pesanan-list'}mm-active{/if}"><a href="{$_url}pesanan/list/">Daftar Pesanan</a></li>
									<li class="{if $_sysfrm_menu2 eq 'pesanan-add'}mm-active{/if}"><a href="{$_url}pesanan/add/">Tambah Pesanan</a></li>
								</ul>
							</li>
							<li class="{if $_sysfrm_menu1 eq 'penjualan'}mm-active{/if}">
								<a class="has-arrow" href="#"><i class="fa fa-user"></i> Penjualan</a>
								<ul class="nav-third-level">
									<li class="{if $_sysfrm_menu2 eq 'penjualan-list'}mm-active{/if}"><a href="{$_url}penjualan/list/">Daftar Penjualan</a></li>
									<li class="{if $_sysfrm_menu2 eq 'penjualan-add'}mm-active{/if}"><a href="{$_url}penjualan/add/">Tambah Penjualan</a></li>
								</ul>
							</li>
						</ul>
					</li>
					<li class="{if $_sysfrm_menu eq 'pembayaran'}mm-active{/if}">
						...
						<ul class="nav-second-level">
							...
							<li class="{if $_sysfrm_menu2 eq 'bayar-list'}mm-active{/if}"><a href="{$_url}bayar/list/">Daftar Pembayaran</a></li>
							<li class="{if $_sysfrm_menu2 eq 'bayar-add'}mm-active{/if}"><a href="{$_url}bayar/add/">Tambah Pembayaran</a></li>
						</ul>
					</li>
                    ...
                    {if $_c['accounting'] eq '1'}
                        <li class="{if $_sysfrm_menu eq 'transactions'}mm-active{/if}">
                            <a class="has-arrow" href="#"><i class="fa fa-database"></i> <span class="nav-label">Financial</span></a>
                            <ul class="nav-second-level">
                    ...
                    {if $_c['accounting'] eq '1'}
                        <li class="{if $_sysfrm_menu eq 'accounts'}mm-active{/if}">
                            <a class="has-arrow" href="#"><i class="fa fa-building-o"></i> <span class="nav-label">{$_L['Bank n Cash']}</span></a>
                            <ul class="nav-second-level">
