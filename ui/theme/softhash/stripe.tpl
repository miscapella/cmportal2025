                ...
                <header class="clearfix">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right mt-md mb-md">
                            <h3>{$_L['Total Amount']}: {$_c['currency_code']} {number_format($d['total'],2,$_c['dec_point'],$_c['thousands_sep'])}</h3>
                                ...
                                <div class="panel-heading display-table" >
                                    <div class="row display-tr" >
                                        ...
                                        <div class="display-td" >
                                            <img class="img-responsive pull-right" src="ui/lib/imgs/credit-cards.png">
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
