        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <form id="invform" method="post">
                <div class="ibox-content p-xl" id="ibox_form">
                    ...
                    <div class="table-responsive m-t">
                        <table class="table invoice-table" id="invoice_items">
                            ...
                            <tr>
                                ...
                                <th width="8%">{$_L['Qty']}</th>
                                <th width="10%">{$_L['Price']}</th>
                                <th width="17%">{$_L['Total']}</th>
                                {*<th width="10%">Tax</th>*}
                            </tr>
                            </thead>
                            <tbody>
                            {foreach $items as $item}
                                <tr>
                                    <td><input type="text" class="form-control item_name" name="code[]"
                                               value="{$item['itemcode']}"></td>
                                    <td><input type="text" class="form-control item_name" name="desc[]"
                                               value="{$item['description']}"></td>
                                    <td><input type="text" class="form-control item_name" name="batch[]"
                    ...
                    <button type="button" class="btn btn-primary" id="item-add"><i class="fa fa-search"></i> {$_L['Add Product']}
                    </button>
