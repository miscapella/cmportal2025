            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" method="post" id="tform" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  value="{{date( $_c['df'], strtotime($t['date']))}}" name="date" id="date" datepicker data-date-format="dd-mm-yyyy" data-auto-close="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control amount" id="amount"  data-a-sign="{$_c['currency_code']} " data-d-group="3" value="{$t['amount']}"  name="amount" disabled>
                        </div>
                    </div>
