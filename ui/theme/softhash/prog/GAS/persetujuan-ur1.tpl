	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body {if $d['priority'] eq 'URGENT'}red-bg{else}blue-bg{/if}">
			    ...
			    <div class="col-lg-6" style="text-align: right"><a href="{$_url}persetujuan/persetujuan-ur/" class="btn btn-primary btn-sm">Back</a></div>
            </div>
        </div>
    </div>
</div>
		...
		<div class="panel panel-default">
			<div class="panel-body detail-pr-head">
				...
				<div class="form-group"><label class="col-lg-3 control-label" for="dibuat_nama">Dibuat Oleh</label>
					<div class="col-lg-9"><input type="text" id="dibuat_nama" name="dibuat_nama" class="form-control" value="{$d['dibuat_nama']}" disabled>
					</div>
				</div>
            </div>
        </div>
