...
<input type="hidden" id="no_ur" value="{$es['no_mintabarang']}" class="form-control" />
		...
		<div class="panel panel-default">
			<div class="ibox-title">
				<div class="ibox-tools">
					<a href="{$_url}permintaanbarang/{$previous_uri}/" class="btn btn-primary btn-xs">Daftar User Request</a>
				</div>
			</div>
			<div class="panel-body">
				...
				<!-- <div class="form-group">
					...
					<div class="col-lg-3">
						<input type="text" name="nomor" id="nomor" class="form-control" value="{$es['nomor']}" style="background-color: #f7f7f7;" disabled>
					</div>
				</div><br> -->
				<div class="form-group">
					<label class="col-md-2 control-label" for="no_ur">No UR</label>
					<div class="col-lg-3">
						<input style="background-color: #f7f7f7;" type="text" id="no_ur" name="no_ur" class="form-control" value="{$es['no_mintabarang']}" disabled>
					</div>
				</div><br>
				<div class="form-group">
					<label class="col-md-2 control-label" for="tgl_pr">Tanggal</label>
					<div class="col-lg-3">
						<input style="background-color: #f7f7f7;" type="text" id="tgl" name="tgl" class="form-control" value="{$es['tanggal']|date_format:'%d-%m-%Y'}" data-auto-close="true" disabled>
					</div>
				</div>
                ...
                <form class="form-horizontal" id="rform" autocomplete="off" spellcheck="false">
					...
					<table id='table-add-mr' class="table table-bordered table-hover sys_table">
						<div style="display: flex; align-items: center; justify-content: space-between;margin-bottom: 10px;">
							...
							<button class="btn btn-primary btn-sm" type="submit" id="submit"><i class="fa fa-check"></i> {$_L['Save']}</button>
						</div>
