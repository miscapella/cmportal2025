		...
		<div class="panel panel-default">
			<div class="ibox-title">
				<div class="ibox-tools">
					<a href="{$_url}permintaanbarang/list-mintabarang/" class="btn btn-primary btn-xs">Daftar User Request</a>
				</div>
			</div>
			<div class="panel-body">
				<!-- <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-3"><input style="background-color: #f7f7f7;" type="text" id="tgl" name="tgl" class="form-control" value="{$idate}" datepicker data-date-format="dd-mm-yyyy" data-auto-close="true" disabled>
					</div>
				</div>
