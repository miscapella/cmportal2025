	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body {if $d['priority'] eq 'MENENGAH'}yellow-bg{else if $d['priority'] eq 'TINGGI'}red-bg{/if}">
			    ...
			    <div class="col-lg-6" style="text-align: right"><a href="{$_url}pembelian/list-po-aprv/" class="btn btn-success btn-sm">Back</a></div>
            </div>
        </div>
    </div>
</div>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body detail-pr-head">
                ...
                {foreach $tg3 as $r3}
                    {if $d['kd_supplier'] eq $r3['kd_supplier']}
                        {assign var="nm_supplier" value="{$r3['nm_supplier']}"}
                    {/if}
                {/foreach}
			...
			<div class="panel-body detail-pr-head">
                ...
                <div class="form-group"><label class="col-lg-3 control-label">Approval</label>
					<div class="col-lg-9" style="margin-top: 5px;">
					    <a href="{$_url}pembelian/detail-po-approve/" class="btn btn-primary btn-xs" id="approve">APPROVE</a>
					    <a href="{$_url}pembelian/detail-po-reject/" class="btn btn-danger btn-xs" id="reject">REJECT</a>
					</div>
				</div><br>
            </div>
        </div>
