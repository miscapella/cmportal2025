		...
		<div class="panel panel-default">
			<div class="panel-body">
                ...
                <div class="ibox-tools">
					<a href="{$_url}pembelian/list-{strtolower($d['posisi'])}-{strtolower($d['status'])}/" class="btn btn-primary btn-sm">Daftar PR</a>
				</div>
					...
					<table class="table table-bordered table-hover sys_table">
						...
						{foreach $e as $ds}
							<tr>
								...
								<td style="vertical-align: middle;"><input type="text" name="keperluan[]" class="keperluan" value="{($ds['keperluan'] == 'PENGADAAN') ? 'PENGADAAN BARU' : $ds['keperluan']}" readonly></td>
								<!-- <td style="vertical-align: middle;"><a href="#" class="keperluan">{($ds['keperluan'] == 'PENGADAAN') ? 'PENGADAAN BARU' : $ds['keperluan']}</a></td> -->
								<td style="display: none;"><input type="text" name="kode_item[]" class="kode_item" readonly value="{$ds['kd_item']}"></td>
								...
								<td style="display:none;"><input type="text" name="item[]" class="item" value="{$ds['kd_item']}" readonly></td>
								{assign var="nama_item" value=""}
								{foreach $tg1 as $r1}
									{if $ds['kd_item'] eq $r1['kd_item']}
										{assign var="nama_item" value="{$r1['nm_item']}"}
									{/if}
								{/foreach}
								<td style="vertical-align: middle;"><a href="#" class="detail-itemstock" value="{$ds['kd_item']}">{$nama_item}</a></td>
								...
								<td style="vertical-align: middle;">
									<select name="kode_supplier1[]" class="kode_supplier" style="width: 200px;">
									    ...
									    <!-- {foreach $tg4 as $r4}
									        {if $r4['kd_item'] eq $ds['kd_item']}
									            <option value="{$r4['kd_supplier']}" {if $r4['kd_supplier'] eq $ds['kd_supplier1']} selected{/if}>{$r4['kd_supplier']} - {$r4['nama_supplier']}</option>
									        {/if}
										{/foreach} -->
									</select>
								</td>
								...
								<td style="vertical-align: middle;"><input type="file" id="s{$nourut}file_supplier1" name="sfile_supplier1[]" class="files"><input type="text" id="{$nourut}file_supplier1" name="file_supplier1[]" style="display: none;"></td>
								<td style="vertical-align: middle;">
									<select name="kode_supplier2[]" class="kode_supplier" style="width: 200px;">
										<option value="">Pilih Supplier 2</option>
									    <!-- {foreach $tg4 as $r4}
									        {if $r4['kode_item'] eq $ds['kd_item']}
								...
								<td style="vertical-align: middle;"><input type="file" id="s{$nourut}file_supplier2" name="sfile_supplier2[]" class="files"><input type="text" id="{$nourut}file_supplier2" name="file_supplier2[]" style="display: none;"></td>
								<td style="vertical-align: middle;">
								...
								<td style="vertical-align: middle;"><input type="file" id="s{$nourut}file_supplier3" name="sfile_supplier3[]" class="files"><input type="text" id="{$nourut}file_supplier3" name="file_supplier3[]" style="display: none;"></td>
								<td style="vertical-align: middle;">
								    <input type="radio" name="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan[]" id="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan1[]" class="cekbox" value="supplier1" {if $ds['supplierpilihan'] eq $ds['kode_supplier1'] and $ds['supplierpilihan'] neq '' } checked {/if}> <label style="font-weight: normal" for="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan1[]"> Supplier 1</label><br>
									<input type="radio" name="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan[]" id="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan2[]" class="cekbox" value="supplier2" {if $ds['supplierpilihan'] eq $ds['kode_supplier2'] and $ds['supplierpilihan'] neq ''} checked {/if}> <label style="font-weight: normal" for="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan2[]"> Supplier 2</label><br>
									<input type="radio" name="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan[]" id="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan3[]" class="cekbox" value="supplier3" {if $ds['supplierpilihan'] eq $ds['kode_supplier3'] and $ds['supplierpilihan'] neq ''} checked {/if}> <label style="font-weight: normal" for="{$ds["keperluan"]}{$ds["kd_item"]}supplierpilihan3[]"> Supplier 3</label>
								</td>
							</tr>
