        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover sys_table">
					...
					{assign var="nourut" value=1}
                    {foreach $e as $es}
                        <!-- <tr {if $es['priority'] eq 'TINGGI'}style="background-color:#ffc9bb;"{else if $es['priority'] eq 'MENENGAH'}style="background-color:#f7f5bc;"{/if}> -->
                        <tr>
                            <td>{$nourut} </td>
                            <td>{$es['no_pr']}</td>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover sys_table">
					...
					{assign var="nourut" value=1}
                    {foreach $f as $fs}
                        <!-- <tr {if $fs['priority'] eq 'TINGGI'}style="background-color:#ffc9bb;"{else if $fs['priority'] eq 'MENENGAH'}style="background-color:#f7f5bc;"{/if}> -->
                        <tr>
                            <td>{$nourut} </td>
                            <td>{$fs['no_pr']}</td>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover sys_table">
					...
					{assign var="nourut" value=1}
                    {foreach $g as $gs}
                        <tr {if $gs['priority'] eq 'TINGGI'}style="background-color:#ffc9bb;"{else if $gs['priority'] eq 'MENENGAH'}style="background-color:#f7f5bc;"{/if}>
                            <td>{$nourut} </td>
                            <td>{$gs['no_pr']}</td>
