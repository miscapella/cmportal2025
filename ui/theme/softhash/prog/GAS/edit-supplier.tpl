            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" id="rformsupplier" autocomplete="off" spellcheck="false">
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="bidang"><span style="color: red;">*</span> Jenis Usaha</label>
                        <div class="col-lg-9"><input type="text" id="bidang" name="bidang" class="form-control" value="{$d['bidang']}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label">Foto Toko</label>
                        <div class="col-lg-3">
                            {if $d['foto_toko'] neq ''}
                            <a href="uploads/GAS/supplier/{$d['foto_toko']}" target="_blank" class="form-control">Klik disini untuk membuka file</a>
                            {else}
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="telp_toko">Telepon Toko</label>
                        <div class="col-lg-9"><input type="text" id="telp_toko" name="telp_toko" value="{$d['telp_toko']}" class="form-control" placeholder="Nomor Telepon Toko">
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="hp_toko">Nomor HP Toko</label>
                        <div class="col-lg-9"><input type="text" id="hp_toko" name="hp_toko" value="{$d['hp_toko']}" class="form-control" placeholder="Nomor HP Toko">
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="file_nib">File NIB</label>
                        <div class="col-lg-3">
                            {if $d['file_nib'] neq ''}
                            <a href="uploads/GAS/supplier/{$d['file_nib']}" target="_blank" class="form-control">Klik disini untuk membuka file</a>
                            {else}
                            <a class="form-control">Tidak ada file</a>
                            {/if}
                        </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="file_npwp">File NPWP</label>
                        <div class="col-lg-3">
                            {if $d['file_npwp'] neq ''}
                            <a href="uploads/GAS/supplier/{$d['file_npwp']}" target="_blank" class="form-control">Klik disini untuk membuka file</a>
                            {else}
                            <a class="form-control">Tidak ada file</a>
                            {/if}
                        </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="file_kontrak">File Kontrak</label>
                        <div class="col-lg-3">
                            ...
                            <a href="uploads/GAS/supplier/{$d['file_kontrak']}" target="_blank" class="form-control">Klik disini untuk membuka file</a>
                            {else}
                            <a class="form-control">Tidak ada file</a>
                            {/if}
                        </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="maps">Google Maps</label>
                        <div class="col-lg-9"><input type="text" id="maps" name="maps"  class="form-control" value="{$d['maps']}" placeholder="Link Google Maps">
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="file_ktp">File KTP</label>
                        <div class="col-lg-3">
                            {if $d['file_ktp'] neq ''}
                            <a href="uploads/GAS/supplier/{$d['file_ktp']}" target="_blank" class="form-control">Klik disini untuk membuka file</a>
                            {else}
                            <a class="form-control">Tidak ada file</a>
                            {/if}
                        </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="nik_ktp">NIK KTP</label>
                        <div class="col-lg-9"><input type="text" id="nik_ktp" name="nik_ktp" value="{$d['nik_ktp']}" class="form-control" placeholder="NIK KTP">
                        </div>
                    </div>
                     <!-- Added By Elvies 11/12/2023 -->
                    <div class="form-group"><label class="col-lg-3 control-label" for="nama_pemilik">Nama Pemilik</label>
                        <div class="col-lg-9"><input type="text" id="nama_pemilik" name="nama_pemilik" class="form-control" value="{$d['nama_pemilik']}" placeholder="-">
                        </div>
                    </div>
                     <!-- Added By Elvies 11/12/2023 -->
                    <div class="form-group"><label class="col-lg-3 control-label" for="hp_pemilik">NO HP Pemilik</label>
                        <div class="col-lg-9"><input type="text" id="hp_pemilik" name="hp_pemilik" class="form-control" value="{$d['hp_pemilik']}" placeholder="-">
                        </div>
                    </div>
                     <!-- Added By Elvies 11/12/2023 -->
                    ...
                    <!-- <div class="form-group"><label class="col-lg-3 control-label" for="hp_pemilik">No HP Pemilik</label>
                        ...
                        <!-- <div class="col-lg-8"><input type="text" id="hp_pemilik" name="hp_pemilik" class="form-control" value="{$ehp_pemilik[1]}" placeholder="-">
                        </div>
                    </div> -->
                    <div class="form-group"><label class="col-lg-3 control-label" for="nama_contact">Nama Contact</label>
                        <div class="col-lg-9"><input type="text" id="nama_contact" name="nama_contact" class="form-control" value="{$d['nama_contact']}" placeholder="-">
                        </div>
                    </div>
                    <!-- Added By Elvies 11/12/2023 -->
                    <div class="form-group"><label class="col-lg-3 control-label" for="hp_contact">Hp Contact</label>
                        <div class="col-lg-9"><input type="text" id="hp_contact" name="hp_contact" value="{$d['hp_contact']}" class="form-control" placeholder="HP Contact">
                        </div>
                    </div>
                    <!-- Added By Elvies 11/12/2023 -->
                    ...
                    <!-- <div class="form-group"><label class="col-lg-3 control-label" for="hp_contact">No HP Contact</label>
                        ...
                        <div class="col-lg-8"><input type="text" id="hp_contact" name="hp_contact" class="form-control" value="{$ehp_contact[1]}" placeholder="-">
                        </div>
                    </div> -->
                    <div class="form-group"><label class="col-lg-3 control-label" for="nama_emergency">Nama Emergency Contact</label>
                        <div class="col-lg-9"><input type="text" id="nama_emergency" name="nama_emergency" class="form-control" value="{$d['nama_emergency']}" placeholder="-">
                        </div>
                    </div>
                    <!-- <div class="form-group"><label class="col-lg-3 control-label" for="hp_emergency">No HP Emergency</label>
                        ...
                        <div class="col-lg-8"><input type="text" id="hp_emergency" name="hp_emergency" class="form-control" value="{$ehp_emergency[1]}" placeholder="-">
                        </div>
                    </div> -->
                    <!-- Added By Elvies 11/12/2023 -->
                    <div class="form-group"><label class="col-lg-3 control-label" for="hp_emergency">Hp Emergency</label>
                        <div class="col-lg-9"><input type="text" id="hp_emergency" name="hp_emergency" value="{$d['hp_emergency']}" class="form-control" placeholder="HP Emergency">
                        </div>
                    </div>
                    <!-- Added By Elvies 11/12/2023 -->
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="bank">Nama Bank</label>
                        <div class="col-lg-9"><input type="text" id="bank" name="bank" class="form-control" value="{$d['bank']}" placeholder="-">
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-3 control-label" for="no_rekening">Nomor Rekening</label>
                        <div class="col-lg-9"><input type="text" id="no_rekening" name="no_rekening" class="form-control"  value="{$d['no_rekening']}" placeholder="-">
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-3 control-label" for="an_rekening">Atas Nama Rekening</label>
                        <div class="col-lg-9"><input type="text" id="an_rekening" name="an_rekening" class="form-control" value="{$d['an_rekening']}" placeholder="-">
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="file_rekening">File Rekening</label>
                        <div class="col-lg-3">
                            {if $d['file_rekening'] neq ''}
                            <a href="uploads/GAS/supplier/{$d['file_rekening']}" target="_blank" class="form-control">Klik disini untuk membuka file</a>
                            {else}
                            <a class="form-control">Tidak ada file</a>
                            {/if}
                        </div>
                        ...
                        <div class="col-lg-3"><input type="file" id="file_rekening" name="file_rekening" class="files">
                            <p>Max 5 MB</p>
                            <input type="text" id="sfile_rekening" name="sfile_rekening" value="{$d['file_rekening']}" style="display: none;">
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="alasan_non_aktif">Alasan Non  Aktif</label>
                        <div class="col-lg-9"><input type="text" id="alasan_non_aktif" name="alasan_non_aktif" class="form-control" placeholder="-"
                            value="{if $d['active'] eq 'N'} {$d['alasan_non_aktif']} {/if}"
                            {if $d['active'] eq 'Y'} readonly {/if}>
                        </div>
                    </div><br />
                    <div class="form-group"><label class="col-lg-3 control-label" for="blocked">Blacklist Supplier</label>
                        <div class="col-lg-9"><input class="form-check-input" type="checkbox" id="blocked" name="blocked" value="Y" {if $d['blocked'] eq 'Y'} checked {/if}>
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-3 control-label" for="alasan_blocked">Alasan Blacklist</label>
                        <div class="col-lg-9"><input type="text" id="alasan_blocked" name="alasan_blocked" class="form-control" placeholder="-"
                            value="{if $d['blocked'] eq 'Y'} {$d['alasan_blocked']} {/if}"
                            {if $d['blocked'] eq 'N'} readonly {/if}>
                        </div>
                    </div>
                    <div class="form-group">
