                    ...
                    {foreach $d as $ds}
                        <!-- <tr {if $ds['priority'] eq 'TINGGI'}style="background-color:#ffc9bb;"{else if $ds['priority'] eq 'MENENGAH'}style="background-color:#f7f5bc;"{/if}> -->
                            ...
                            <td class="text-right">
                                ...
                                <a href="{$_url}pembelian/edit-po/{$ds['id']}/" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o"></i> Revisi</a>
                                <a href="delete/pembelian/{$ds['id']}/" class="btn btn-danger btn-xs cdelete" id="uid{$ds['id']}"><i class="fa fa-trash"></i> Cancel</a>
                            </td>
                        </tr>
