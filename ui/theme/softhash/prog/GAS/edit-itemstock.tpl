            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" id="rform" autocomplete="off" spellcheck="false">
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="kode">Kode Item Stock</label>
                        <div class="col-lg-9"><input type="text" id="kode" name="kode" class="form-control" style="text-transform:uppercase" value="{$d['kd_item']}" disabled>
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-3 control-label" for="nama"><span style="color: red;">*</span> Nama Item Stock</label>
                        <div class="col-lg-9"><input type="text" id="nama" name="nama" class="form-control" value="{$d['nm_item']}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="kategori" id="kategori" class="form-control">
                                ...
                                <option value="Umum" {if $d['kategori'] == "Umum"}selected{/if}>Umum</option>
                                <option value="IT" {if $d['kategori'] == "IT"}selected{/if}>IT</option>
                                <option value="Service" {if $kategori == "Service"}selected{/if}>Service</option>
                            </select>
                        </div>
                    </div>
