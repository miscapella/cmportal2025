            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="ibox_form">
                    ...
                    <form class="form-horizontal" id="rformcabang">
                        <input type="hidden" name="cid" id="cid" value="{$cabang['id']}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" id="work_location1" name="work_location1" class="form-control" placeholder="Work Location" disabled value="{$selectedWorkLocation}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="spreadsheet_link"><span style="color: red;">*</span> Link Spreadsheet (.xlsx)</label>
                            <div class="col-lg-9">
                                <input type="text" id="spreadsheet_link" name="spreadsheet_link" class="form-control" placeholder="Link Spreadsheet (.xlsx)" value="{$cabang['link_spreadsheet']}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" id="mitra_spreadsheet_link" name="mitra_spreadsheet_link" class="form-control" placeholder="Link Spreadsheet Mitra (.xlsx)" value="{$cabang['link_spreadsheet_mitra']}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="is_udt"> Cabang UDT</label>
                            <div class="col-lg-9">
                                <input type="checkbox" id="is_udt" name="is_udt" {if $cabang['is_udt'] eq 1}checked{/if}>
                            </div>
                        </div>
                        <div class="form-group">
