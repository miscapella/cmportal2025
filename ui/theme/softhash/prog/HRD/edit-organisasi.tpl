        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" id="rformorganisasi">
                    ...
                    <input type="hidden" name="id_posisi_before" id="id_posisi_before" value="{$d['id_posisi']}">
                  ...
                  <div class="form-group"><label class="col-lg-3 control-label" for="id_posisi"><span style="color: red;">*</span> Id Posisi</label>
                      <div class="col-lg-9"><input type="text" id="id_posisi" name="id_posisi" class="form-control" placeholder="Id Posisi" value="{$d['id_posisi']}">
                      </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="nama_internal"><span style="color: red;">*</span> Nama Internal</label>
                    <div class="col-lg-9"><input type="text" id="nama_internal" name="nama_internal" class="form-control" placeholder="Nama Internal" value="{$d['nama_internal']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="nama_eksternal"> Nama Eksternal</label>
                    <div class="col-lg-9"><input type="text" id="nama_eksternal" name="nama_eksternal" class="form-control" placeholder="Nama Eksternal" value="{$d['nama_eksternal']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="deskripsi"> Deskripsi</label>
                    <div class="col-lg-9"><input type="text" id="deskripsi" name="deskripsi" class="form-control" placeholder="Deskripsi" value="{$d['deskripsi']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="pekerjaan"> Pekerjaan</label>
                    <div class="col-lg-9"><input type="text" id="pekerjaan" name="pekerjaan" class="form-control" placeholder="Pekerjaan" value="{$d['pekerjaan']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="nama_pekerjaan"> Nama Pekerjaan</label>
                    <div class="col-lg-9"><input type="text" id="nama_pekerjaan" name="nama_pekerjaan" class="form-control" placeholder="Nama Pekerjaan" value="{$d['nama_pekerjaan']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="nilai_posisi"> Nilai Posisi</label>
                    <div class="col-lg-9"><input type="text" id="nilai_posisi" name="nilai_posisi" class="form-control" placeholder="Nilai Posisi" value="{$d['nilai_posisi']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="valid_dari"><span style="color: red;">*</span> Valid Dari</label>
                    <div class="col-lg-9"><input type="date" id="valid_dari" name="valid_dari" class="form-control" placeholder="Valid Dari" value="{$d['valid_dari']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="valid_sampai"><span style="color: red;">*</span> Valid Sampai</label>
                    <div class="col-lg-9"><input type="date" id="valid_sampai" name="valid_sampai" class="form-control" placeholder="Valid Sampai" value="{$d['valid_sampai']}">
                    </div>
                  </div>
                  ...
                  <div class="form-group"><label class="col-lg-3 control-label" for="parent_valid_dari"><span style="color: red;">*</span> Parent Valid Dari</label>
                    <div class="col-lg-9"><input type="date" id="parent_valid_dari" name="parent_valid_dari" class="form-control" placeholder="Parent Valid Dari" value="{$d['parent_valid_dari']}">
                    </div>
                  </div>
                  <div class="form-group"><label class="col-lg-3 control-label" for="parent_valid_sampai"><span style="color: red;">*</span> Parent Valid Sampai</label>
                    <div class="col-lg-9"><input type="date" id="parent_valid_sampai" name="parent_valid_sampai" class="form-control" placeholder="Parent Valid Sampai" value="{$d['parent_valid_sampai']}">
                    </div>
                  </div>
                  <div class="form-group">
