            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" id="ibox_form">
                    ...
                    <form class="form-horizontal" id="rformcabang">
                        <input type="hidden" name="cid" id="cid" value="{$branch['id']}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9">
                                <input type="text" id="branch_name" name="branch_name" class="form-control" placeholder="Branch Name" value="{$branch['branch_name']}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-3 control-label" for="work_location"><span style="color: red;">*</span> Work Location</label>
                            <div class="col-lg-9">
                                <input type="text" id="work_location" name="work_location" class="form-control" placeholder="Work Location" value="{$branch['work_location']}">
                            </div>
                        </div>
                        <div class="form-group">
