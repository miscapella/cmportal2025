...
<div class="row">
  <div class="col-md-9">
    ...
    <div class="hexagon-container4" style="margin-left: -15px">
      <a href="{$_url}inventaris/detail/{$id_inventaris}/" class="hexagon4"
        >{$nama_inventaris}</a
      >
    </div>
    <div class="hexagon-container2" style="margin-left: -15px">
      <a href="{$_url}inventaris/detail-item/{$id_inventaris}/{$id_item}/" class="hexagon2"
        >{$nama_item}</a
      >
    </div>
  </div>
  <div class="col-md-3">
    <a
      href="{$_url}inventaris/addkomponen/{$id_inventaris}/{$id_item}"
