                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="cid" name="cid" class="form-control">
                                                ...
                                                {foreach $c as $cs}
                                                    <option value="{$cs['id']}"
                                                            {if $p_cid eq ($cs['id'])}selected="selected" {/if}>{$cs['no_pesan']}</option>
                                                {/foreach}
	...
	<div class="tab-content">
		...
		<div id="menu2" class="tab-pane fade">
			...
			<div class="form-group row">
			  ...
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="harga" name="harga" readonly placeholder="Isi Harga Kosong Kenderaan" value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			</div>
			<div class="form-group row">
			  <label class="col-sm-2 col-form-label">Biaya Surat</label>
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="by_surat" name="by_surat" placeholder="Isi Baiya Surat" value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			</div>
			<div class="form-group row">
			  <label class="col-sm-2 col-form-label">Discount</label>
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="disc" name="disc" placeholder="Isi Discount" value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			</div>
			<div class="form-group row">
			  <label class="col-sm-2 col-form-label">Harga On The Road</label>
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="total" name="total" readonly value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			</div>
			<div class="form-group row">
			  <label class="col-sm-2 col-form-label">Panjar</label>
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="panjar" name="panjar" readonly placeholder="Isi Panjar" value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			</div>
			<div class="form-group row">
			  <label class="col-sm-2 col-form-label">Total Bayar Panjar</label>
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="bayar" name="bayar" readonly placeholder="Isi Panjar" onkeypress="return isNumberKey(event)" value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			  <label class="col-sm-3 col-form-label">Sisa Panjar yang blm dibayar</label>
			  <div class="col-sm-3">
				<input type="text" class="form-control amount" id="sisa" name="sisa" readonly placeholder="Isi Panjar" value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
			  </div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Harga Netto</label>
				<div class="col-sm-3">
					<input type="text" class="form-control amount" id="jumlah" name="jumlah" readonly value=0 style="text-align:right" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">
				</div>
			</div>
		</div>
	</div>
