                            ...
                            <div class="col-md-6">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" readonly class="form-control" id="no" name="no" value="{$d['no_pesan']}">
                                        </div>
                                    </div>
                                    <div class="form-group">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="type" name="type" placeholder="Isi Type Kenderaan" value="{$d['type_mobil']}">
                                        </div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="tahun">Tahun Buat</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="tahun" name="tahun" placeholder="Tahun Pembuatan" value="{$d['thn_buat']}">
                                        </div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="warna">Warna</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="warna" name="warna" placeholder="Isi Warna Kenderaan" value="{$d['warna']}">
                                        </div>
									</div>
									<div class="form-group">
										<label for="amount" class="col-sm-3 control-label">Harga OTR</label>
										<div class="col-sm-9">
											<input type="text" class="form-control amount" id="harga"  data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3" name="harga" value={$d['harga']} style="text-align:right">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label" for="panjar">panjar</label>
                                        <div class="col-sm-9">
											<input type="text" class="form-control amount" id="panjar"  data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3" name="panjar" value={$d['panjar']} style="text-align:right">
                                        </div>
									</div>
