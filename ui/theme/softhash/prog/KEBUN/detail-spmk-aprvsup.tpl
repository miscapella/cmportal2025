        ...
        <div class="panel panel-default">
            <div class="panel-body detail-pr-input" style="overflow:auto;white-space:nowrap;">
                ...
                <div style="display: none;">
                    <input class="col-lg-9" type="text" id="kontrak" name="kontrak[]" class="form-control" value="{$ds['id']}" style="display: none;">
                </div>
                ...
                <div class="form-group">
                    <div class="form-group col-lg-4 {if $ds['kontraktorpilihan'] eq $ds['kontraktor1']} supplierpilihan {/if}" style="border-right: 1px solid #e7eaec;">
                        <div class="row">
                             <input type="radio" name="{$ds["id"]}supplierpilihan[]" class="cekbox col-lg-12" {if $ds['kontraktorpilihan'] eq $ds['kontraktor1']} checked {/if} value="{$ds['kontraktor1']}">
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="supplier1">Kontraktor 1</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="supplier1" name="supplier1" class="form-control" value="{$ds['kontraktor1']}" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input class="col-lg-8" type="text" id="keterangan_supplier1" name="keterangan_supplier1" class="form-control" value="{$ds['keterangan_kontraktor1']}" disabled>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-group col-lg-4 {if $ds['kontraktorpilihan'] eq $ds['kontraktor2']} supplierpilihan {/if}" style="border-right: 1px solid #e7eaec">
                        <div class="row">
                            <input type="radio" name="{$ds["id"]}supplierpilihan[]" class="cekbox col-lg-12" {if $ds['kontraktorpilihan'] eq $ds['kontraktor2']} checked {/if} value="{$ds['kontraktor2']}">
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="supplier2">Kontraktor 2</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="supplier2" name="supplier2" class="form-control" value="{$ds['kontraktor2']}" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input class="col-lg-8" type="text" id="keterangan_supplier2" name="keterangan_supplier2" class="form-control" value="{$ds['keterangan_kontraktor2']}" disabled>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-group col-lg-4 {if $ds['kontraktorpilihan'] eq $ds['kontraktor3']} supplierpilihan {/if}">
                        <div class="row">
                            <input type="radio" name="{$ds["id"]}supplierpilihan[]" class="cekbox col-lg-12" {if $ds['kontraktorpilihan'] eq $ds['kontraktor3']} checked {/if} value="{$ds['kontraktor3']}">
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="supplier3">Kontraktor 3</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="supplier3" name="supplier3" class="form-control" value="{$ds['kontraktor3']}" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input class="col-lg-8" type="text" id="keterangan_supplier3" name="keterangan_supplier3" class="form-control" value="{$ds['keterangan_kontraktor3']}" disabled>
                        </div>
                        <div class="row">
