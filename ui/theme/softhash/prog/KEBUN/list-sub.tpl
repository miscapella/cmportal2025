...
<div class="row">
	<div class="col-md-9">
        ...
        <div class="hexagon-container2" style="margin-left: -15px;">
            <a href="{$_url}kategori/sub/{$parent}/{$sub}/" class="hexagon2" style="font-size: 0.8vw; line-height: 1; width: 70%;">{$nama_bagian}</a>
        </div>
    </div>
    <div class="col-md-3">
        <a href="{$_url}kategori/addsub/{$parent}/{$sub}/" class="btn btn-success btn-block"><i class="fa fa-plus"></i>  Tambah Data</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
                ...
                <table class="table table-bordered table-hover sys_table">
                    ...
                    {foreach $d as $ds}
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{$_url}kategori/line/{$parent}/{$sub}/{$ds['id']}/" class="btn btn-primary btn-xs"><i class="fa fa-cogs"></i> Details</a>
