	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body {if $d['priority'] eq 'URGENT'}red-bg{else}blue-bg{/if}">
			    ...
			    <div class="col-lg-6" style="text-align: right"><a href="{$_url}pembelian/list-spnk-aprv/" class="btn btn-primary btn-sm">Back</a></div>
            </div>
        </div>
    </div>
</div>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body detail-pr-head">
				...
				{if $d['ktr_disetujui_nama'] neq ''}
				<div class="form-group"><label class="col-lg-3 control-label" for="ktr_disetujui">Kontraktor Disetujui Oleh</label>
					<div class="col-lg-5"><input type="text" id="ktr_disetujui" name="ktr_disetujui" class="form-control" value="{if $d['ktr_disetujui_nama'] neq ''}{$d['ktr_disetujui_nama']}{else}Menunggu Approval{/if}" disabled></div>
                    <label class="col-lg-2 control-label text-right" for="tglktr_disetujui">Tanggal Kontraktor Disetujui</label>
                    <div class="col-lg-2"><input type="text" id="tglktr_disetujui" name="tglktr_disetujui" class="form-control" value="{$d['ktr_disetujui_tgl']}" datepicker data-date-format="dd-mm-yyyy" data-auto-close="true" disabled>
					</div>
				</div><br>
				{/if}
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body detail-pr-input" style="overflow:auto;white-space:nowrap;">
                ...
                {/foreach}
                <div class="form-group">
                    <div class="form-group col-lg-4 {if $ds['kontraktorpilihan'] eq $ds['kontraktor1']} supplierpilihan {/if}" style="border-right: 1px solid #e7eaec;">
                        <div class="row">
                            <input type="radio" name="{$ds["id"]}kontraktorpilihan[]" class="cekbox col-lg-12" {if $ds['kontraktorpilihan'] eq $ds['kontraktor1']} checked {/if} value="kontraktor1" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="kontraktor1">Kontraktor 1</label><span class="col-lg-1" style="text-align: right">:</span>
                            <a href="#" class="col-lg-8 detail-kontraktor" value="{$ds['kontraktor1']}">{$ds['kontraktor1']}</a>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="nama_kontraktor1">Nama</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="nama_kontraktor1" name="nama_kontraktor1" class="form-control" value="{$nama_kontraktor1}" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input class="col-lg-8" type="text" id="keterangan_kontraktor1" name="keterangan_kontraktor1" class="form-control" value="{$ds['keterangan_kontraktor1']}" disabled>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-group col-lg-4 {if $ds['kontraktorpilihan'] eq $ds['kontraktor2']} supplierpilihan {/if}" style="border-right: 1px solid #e7eaec">
                        <div class="row">
                            <input type="radio" name="{$ds["id"]}kontraktorpilihan[]" class="cekbox col-lg-12" {if $ds['kontraktorpilihan'] eq $ds['kontraktor2']} checked {/if} value="kontraktor2" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="kontraktor2">Kontraktor 2</label><span class="col-lg-1" style="text-align: right">:</span>
                            <a href="#" class="col-lg-8 detail-kontraktor" value="{$ds['kontraktor2']}">{$ds['kontraktor2']}</a>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="nama_kontraktor2">Nama</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="nama_kontraktor2" name="nama_kontraktor2" class="form-control" value="{$nama_kontraktor2}" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input class="col-lg-8" type="text" id="keterangan_kontraktor2" name="keterangan_kontraktor2" class="form-control" value="{$ds['keterangan_kontraktor2']}" disabled>
                        </div>
                        <div class="row">
                    ...
                    <div class="form-group col-lg-4 {if $ds['kontraktorpilihan'] eq $ds['kontraktor3']} supplierpilihan {/if}">
                        <div class="row">
                            <input type="radio" name="{$ds["id"]}kontraktorpilihan[]" class="cekbox col-lg-12" {if $ds['kontraktorpilihan'] eq $ds['kontraktor3']} checked {/if} value="kontraktor3" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="kontraktor3">Kontraktor 3</label><span class="col-lg-1" style="text-align: right">:</span>
                            <a href="#" class="col-lg-8 detail-kontraktor" value="{$ds['kontraktor3']}">{$ds['kontraktor3']}</a>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="nama_kontraktor3">Nama</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="nama_kontraktor3" name="nama_kontraktor3" class="form-control" value="{$nama_kontraktor3}" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input class="col-lg-8" type="text" id="keterangan_kontraktor3" name="keterangan_kontraktor3" class="form-control" value="{$ds['keterangan_kontraktor3']}" disabled>
                        </div>
                        <div class="row">
