	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body {if $d['priority'] eq 'TIDAK URGENT'}blue-bg{else if $d['priority'] eq 'URGENT'}red-bg{/if}">
			    ...
			    <div class="col-lg-6" style="text-align: right"><a href="{$_url}pembelian/list-po{if $d['status'] eq 'PENDING'}-pending{else if $d['status'] eq 'REJECT'}-reject{/if}/" class="btn btn-primary btn-sm">Back</a></div>
            </div>
        </div>
    </div>
</div>
