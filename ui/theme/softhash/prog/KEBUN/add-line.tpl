        ...
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
					<a href="{$_url}kategori/sub/{$parent}/{$main}" class="btn btn-primary btn-xs">Back</a>
				</div>

            </div>
            <div class="ibox-content" id="ibox_form">
                <input type="text" id="parent" name="parent" class="form-control" value="{$parent}" style="display: none;">
                <input type="text" id="main" name="main" class="form-control" value="{$main}" style="display: none;">
                <input type="text" id="sub" name="sub" class="form-control" value="{$sub}" style="display: none;">
                <div class="alert alert-danger" id="emsg">
                    <span id="emsgbody"></span>
                </div>
                <form class="form-horizontal" id="rform">
                    <input type="text" id="subs" name="subs" class="form-control" value="{$sub}" style="display: none;">
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="main">Main Data</label>
                        <div class="col-lg-9"><input type="text" id="main" name="main" class="form-control" value="{$e['nama_kategori']}" readonly>
                        </div>
                    </div>
                    <div class="form-group"><label class="col-lg-3 control-label" for="sub">Sub Data</label>
                        <div class="col-lg-9"><input type="text" id="sub" name="sub" class="form-control" value="{$f['nama_kategori']}" readonly>
                        </div>
                    </div>
