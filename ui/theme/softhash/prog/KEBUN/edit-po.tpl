		...
		<div class="panel panel-default">
			<div class="panel-body">
                ...
                <div class="ibox-tools">
					<a href="{$_url}pembelian/list-po-pending/" class="btn btn-primary btn-sm">Daftar PO</a>
				</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="form-group"><label class="col-lg-3 control-label" for="no_po">NO PO</label>
					<div class="col-lg-9"><input type="text" id="no_po" name="no_po" class="form-control" value="{$d['no_po']}" readonly></div>
				</div><br>
                ...
                <div class="form-group"><label class="col-lg-3 control-label" for="supplier">Supplier</label>
                    <div class="col-lg-9">
                        <select class="form-control" id="supplier" name="supplier">
                            <option value="{$d['kode_supplier']}">{$d['kode_supplier']} - {$namasupplier}</option>
				...
				<div class="form-group"><label class="col-lg-3 control-label" for="ppn">Ppn</label>
					<div class="col-lg-9"><input type="number" id="ppn" name="ppn" class="form-control" value="{$d['ppn']}"></div>
				</div><br>
				<div class="form-group"><label class="col-lg-3 control-label" for="lokasi_pengiriman">Lokasi Pengiriman</label>
					<div class="col-lg-9"><input type="text" id="lokasi_pengiriman" name="lokasi_pengiriman" class="form-control" value="{$d['lokasi_pengiriman']}"></div>
				</div><br>
				<div class="form-group"><label class="col-lg-3 control-label" for="syarat_pembayaran">Syarat Pembayaran</label>
					<div class="col-lg-9"><input type="text" id="syarat_pembayaran" name="syarat_pembayaran" class="form-control" value="{$d['syarat_pembayaran']}"></div>
				</div><br>
				<div class="form-group"><label class="col-lg-3 control-label" for="catatan">Catatan</label>
					<div class="col-lg-9"><input type="text" id="catatan" name="catatan" class="form-control" value="{$d['catatan']}"></div>
				</div><br>
            </div>
        </div>
    </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body" style="overflow:auto;white-space:nowrap;">
                <form class="form-horizontal" id="rform">
					<input type="hidden" name="kode_inventaris" id="kode_inventaris" value="{$d['kode_inventaris']}">
