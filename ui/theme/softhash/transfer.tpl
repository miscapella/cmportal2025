            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" method="post" id="tform" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  value="{$fdate}" name="date" id="date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true">
                        </div>
                    </div>
                ...
                <table class="table table-bordered sys_table">
                    ...
                    {foreach $tr as $trs}
                        <tr>
                            ...
                            <td class="amount" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3">{$trs['amount']}</td>
                        </tr>
                    {/foreach}
