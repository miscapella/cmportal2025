            ...
            <div class="ibox-content">
                ...
                <form role="form" name="accadd" method="post" action="{$_url}settings/edit-tax-post/">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control amount" id="taxrate" name="taxrate" data-a-sign="{$_c['currency_code']} "  data-a-dec="{$_c['dec_point']}" data-a-sep="{$_c['thousands_sep']}" data-d-group="3" value="{$d['rate']}">
                    </div>
