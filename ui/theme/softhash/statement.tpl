            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" method="post" action="{$_url}reports/statement-view" id="tform" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  value="{$fdate}" name="fdate" id="fdate" datepicker data-date-format="dd-mm-yyyy" data-auto-close="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"  value="{$tdate}" name="tdate" id="tdate" datepicker data-date-format="dd-mm-yyyy" data-auto-close="true">
