    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form
          ...
          method="post"
          action="{$_url}book_room/list/"
        >
          <div class="form-group">
            <div class="col-md-8"></div>
            <div class="col-md-4">
              <a href="{$_url}book_room/add/" class="btn btn-success btn-block"
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        <div class="body-zoom row">
          ...
          <div class="col-md-3">
            {$ds['subjek']} {$ds['nama_ruangan']}<br />
            <span class="pinjaman_zoom"
              >Oleh : {namaBooking($ds['user_id'])}</span
            >
          </div>
          <div class="col-md-3">
            {$ds['jumlah_peserta']} peserta, {$ds['keterangan']}
          </div>
          ...
          <div class="col-md-1">
            ...
            <a
              href="{$_url}book_room/cancel/{$ds['id']}/"
