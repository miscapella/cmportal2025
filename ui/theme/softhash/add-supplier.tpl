        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content" id="ibox_form">
                ...
                <form class="form-horizontal" id="rform">
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="account">{$_L['Full Name']}</label>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="company">{$_L['Company Name']}</label>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="state">{$_L['State Region']}</label>
                    ...
                    {foreach $fs as $f}
                        <div class="form-group"><label class="col-lg-3 control-label" for="cf{$f['id']}">{$f['fieldname']}</label>
                    ...
                    <div class="form-group"><label class="col-lg-3 control-label" for="tags">{$_L['Tags']}</label>
