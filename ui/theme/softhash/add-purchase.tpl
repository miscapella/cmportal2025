                        ...
                        <div class="row">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <span class="help-block">Kosongkan untuk Auto Generate Number Invoice</span>
                                        </div>
                                    </div>-->
                            ...
                            <div class="col-md-6">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="tid" class="col-sm-4 control-label">PPn</label>
