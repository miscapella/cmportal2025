<?php /* Smarty version Smarty-3.1.13, created on 2022-12-23 10:13:36
         compiled from "ui\theme\softhash\sections\header_KUBOTA.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1236152240630d7d2d356eb9-22673108%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '988218e97c62718efe195ee40d27702e06faf765' => 
    array (
      0 => 'ui\\theme\\softhash\\sections\\header_KUBOTA.tpl',
      1 => 1671765083,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1236152240630d7d2d356eb9-22673108',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_630d7d2d413635_60410776',
  'variables' => 
  array (
    '_title' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_630d7d2d413635_60410776')) {function content_630d7d2d413635_60410776($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
/css/mm-vertical.css" rel="stylesheet">
    ...
    <link href="<?php echo $_smarty_tpl->tpl_vars['_theme']->value;?>
/css/style.css?ver=2.0.2" rel="stylesheet">
    <link href="<?php echo $_smarty_tpl->tpl_vars['_theme']->value;?>
...
/"><i class="fa fa-th-large"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Dashboard'];?>
                    ...
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='data'){?>mm-active<?php }?>">
                        ...
                        <ul class="nav-second-level">
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='contact'){?>mm-active<?php }?>">
								<a class="has-arrow" href="#"><i class="fa fa-user"></i> Customer</a>
								<ul class="nav-third-level">
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='addcontact'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
contacts/add/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Add Contact'];?>
</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='listcontact'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
contacts/list/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['List Contacts'];?>
</a></li>
								</ul>
							</li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='formstock'){?>mm-active<?php }?>">
								<a class="has-arrow" href="#"><i class="fa fa-cubes"></i> Form Stock</a>
								<ul class="nav-third-level">
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='form-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
formstock/list/">Daftar Form</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='form-add'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
formstock/add/">Tambah Form</a></li>
								</ul>
							</li>
						</ul>
					</li>
					...
					<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='transaksi'){?>mm-active<?php }?>">
						<a class="has-arrow" href="#"><i class="fa fa-shopping-cart"></i> <span class="nav-label">Transaksi</span></a>
						<ul class="nav-second-level">
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='pesanan'){?>mm-active<?php }?>">
								<a class="has-arrow" href="#"><i class="fa fa-user"></i> Pesanan</a>
								<ul class="nav-third-level">
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='pesanan-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
pesanan/list/">Daftar Pesanan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='pesanan-add'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
pesanan/add/">Tambah Pesanan</a></li>
								</ul>
							</li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='penjualan'){?>mm-active<?php }?>">
								<a class="has-arrow" href="#"><i class="fa fa-user"></i> Penjualan</a>
								<ul class="nav-third-level">
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='penjualan-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
penjualan/list/">Daftar Penjualan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='penjualan-add'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
penjualan/add/">Tambah Penjualan</a></li>
								</ul>
							</li>
						</ul>
					</li>
					<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='pembayaran'){?>mm-active<?php }?>">
						<a class="has-arrow" href="#"><i class="fa fa-database"></i> <span class="nav-label">Pembayaran</span></a>
						<ul class="nav-second-level">
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='panjar-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
panjar/list/">Daftar Bayar Panjar</a></li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='panjar-add'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
panjar/add/">Tambah Panjar</a></li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='bayar-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
bayar/list/">Daftar Pembayaran</a></li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='bayar-add'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
bayar/add/">Tambah Pembayaran</a></li>
						</ul>
					</li>
					...
					<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='reports'){?>mm-active<?php }?>">
						...
						<ul class="nav-second-level">
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='lapjual'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
reports/penjualan/">Laporan Penjualan</a></li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='lappiu'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
reports/piutang/">Laporan Piutang</a></li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='arcard'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
reports/arcard/">Kartu Piutang</a></li>
						</ul>
					</li>
