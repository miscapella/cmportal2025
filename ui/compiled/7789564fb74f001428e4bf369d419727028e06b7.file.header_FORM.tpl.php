<?php /* Smarty version Smarty-3.1.13, created on 2024-05-22 11:26:51
         compiled from "ui\theme\softhash\sections\header_FORM.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1033247721664d735fcc9fd2-86530840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7789564fb74f001428e4bf369d419727028e06b7' => 
    array (
      0 => 'ui\\theme\\softhash\\sections\\header_FORM.tpl',
      1 => 1716352008,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1033247721664d735fcc9fd2-86530840',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_664d735fd89be3_65501295',
  'variables' => 
  array (
    '_title' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_664d735fd89be3_65501295')) {function content_664d735fd89be3_65501295($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
/"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a></li>
                    ...
                    <?php if (_auth2('SHOW-FORM-MASTER',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='data'){?>mm-active<?php }?>">
                        ...
                        <ul class="nav-second-level">
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='listdatatype'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
datatype/list/">Data Type</a></li>
							
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='listform'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
form/list/">Form</a></li>
							
                        </ul>
					</li>
                    <?php }?>
                    <?php if (_auth2('SHOW-FORM-RESPONSE',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='response'){?>mm-active<?php }?>">
                        <a class="has-arrow" href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-file"> Response</span></a>
                        <ul class="nav-second-level">
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='listresponse'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
response/list-form/">List Form Response</a></li>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='exportresponse'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
response/laporan/">Export Response</a></li>
                        </ul>
					</li>
                    <?php }?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='formapprove'){?>mm-active<?php }?>">
                        <a class="has-arrow" href="#"><i class="fa fa-check"></i> Approval</span></a>
                        <ul class="nav-second-level">
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='listapproval'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
approve/list/">List Approval</a></li>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='historyapproval'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
approve/history/">History Approval</a></li>
                        </ul>
					</li>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='formresponse'){?>mm-active<?php }?>">
                        <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
form/list-input/"><i class="fa fa-book"></i> List Form</a>
					</li>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='historyresponse'){?>mm-active<?php }?>">
                        <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
form/history-input/"><i class="fa fa-file"></i> My History</a>
					</li>
                </ul>
