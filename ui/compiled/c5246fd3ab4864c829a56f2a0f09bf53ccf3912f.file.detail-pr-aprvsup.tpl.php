<?php /* Smarty version Smarty-3.1.13, created on 2025-03-10 14:49:59
         compiled from "ui\theme\softhash\prog\KEBUN\detail-pr-aprvsup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8691676746721e64a284441-83462331%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5246fd3ab4864c829a56f2a0f09bf53ccf3912f' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\KEBUN\\detail-pr-aprvsup.tpl',
      1 => 1741592994,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8691676746721e64a284441-83462331',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_6721e64a341908_97470601',
  'variables' => 
  array (
    'msg' => 0,
    'd' => 0,
...
<?php if ($_valid && !is_callable('content_6721e64a341908_97470601')) {function content_6721e64a341908_97470601($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include 'D:\\xampp7.4.8\\htdocs\\cmportal\\sysfrm\\lib\\smarty\\libs\\plugins\\modifier.truncate.php';
...
pembelian/list-pr-aprv/" class="btn btn-primary btn-sm">Back</a></div>
            </div>
        </div>
    </div>
</div>
...
"><?php echo $_smarty_tpl->tpl_vars['nama_item']->value;?>
                    ...
                    <input class="col-lg-9" type="text" id="item" name="item[]" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_item'];?>
" style="display: none;">
				</div><br>
                <div class="form-group" ><label class="col-lg-2 control-label" for="qty_req">Qty Req</label><span class="col-lg-1" style="text-align: right">:</span>
					<div class="col-lg-9" type="text" id="qty_req" name="qty_req[]" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['qty_req'];?>
...
supplierpilihan[]" class="cekbox col-lg-12" <?php if ($_smarty_tpl->tpl_vars['ds']->value['supplierpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kode_supplier1']){?> checked <?php }?> value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_supplier1'];?>
">
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="supplier1">Supplier 1</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="supplier1" name="supplier1" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_supplier1'];?>
" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <label class="col-lg-3 control-label" for="file_supplier1">File</label><span class="col-lg-1" style="text-align: right">:</span><div class="col-lg-8">
                                <?php if ($_smarty_tpl->tpl_vars['ds']->value['file_supplier1']!=''){?>
                                    <?php $_smarty_tpl->tpl_vars["filename"] = new Smarty_variable($_smarty_tpl->tpl_vars['ds']->value['file_supplier1'], null, 0);?>
                                    <?php $_smarty_tpl->tpl_vars["shortname"] = new Smarty_variable(smarty_modifier_truncate($_smarty_tpl->tpl_vars['filename']->value,20,"...",true), null, 0);?>
                                    <a href="uploads/KEBUN/<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" target="_blank" title="<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" style="text-decoration: none;">
                                        <i class="fa fa-file"></i> <?php echo $_smarty_tpl->tpl_vars['shortname']->value;?>
                    ...
                    <div class="form-group col-lg-4 <?php if ($_smarty_tpl->tpl_vars['ds']->value['supplierpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kode_supplier2']){?> supplierpilihan <?php }?>" style="border-right: 1px solid #e7eaec">
                        <div class="row">
                            <input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["keperluan"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["kode_item"];?>
supplierpilihan[]" class="cekbox col-lg-12" <?php if ($_smarty_tpl->tpl_vars['ds']->value['supplierpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kode_supplier2']){?> checked <?php }?> value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_supplier2'];?>
">
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="supplier2">Supplier 2</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="supplier2" name="supplier2" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_supplier2'];?>
" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <label class="col-lg-3 control-label" for="file_supplier2">File</label><span class="col-lg-1" style="text-align: right">:</span><div class="col-lg-8">
                                <?php if ($_smarty_tpl->tpl_vars['ds']->value['file_supplier2']!=''){?>
                                    <?php $_smarty_tpl->tpl_vars["filename"] = new Smarty_variable($_smarty_tpl->tpl_vars['ds']->value['file_supplier2'], null, 0);?>
                                    <?php $_smarty_tpl->tpl_vars["shortname"] = new Smarty_variable(smarty_modifier_truncate($_smarty_tpl->tpl_vars['filename']->value,20,"...",true), null, 0);?>
                                    <a href="uploads/KEBUN/<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" target="_blank" title="<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" style="text-decoration: none;">
                    ...
                    <div class="form-group col-lg-4 <?php if ($_smarty_tpl->tpl_vars['ds']->value['supplierpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kode_supplier3']){?> supplierpilihan <?php }?>">
                        <div class="row">
                            <input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["keperluan"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["kode_item"];?>
supplierpilihan[]" class="cekbox col-lg-12" <?php if ($_smarty_tpl->tpl_vars['ds']->value['supplierpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kode_supplier3']){?> checked <?php }?> value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_supplier3'];?>
">
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="supplier3">Supplier 3</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="supplier3" name="supplier3" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kode_supplier3'];?>
" disabled>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <label class="col-lg-3 control-label" for="file_supplier3">File</label><span class="col-lg-1" style="text-align: right">:</span><div class="col-lg-8">
                                <?php if ($_smarty_tpl->tpl_vars['ds']->value['file_supplier3']!=''){?>
                                    <?php $_smarty_tpl->tpl_vars["filename"] = new Smarty_variable($_smarty_tpl->tpl_vars['ds']->value['file_supplier3'], null, 0);?>
                                    <?php $_smarty_tpl->tpl_vars["shortname"] = new Smarty_variable(smarty_modifier_truncate($_smarty_tpl->tpl_vars['filename']->value,20,"...",true), null, 0);?>
                                    <a href="uploads/KEBUN/<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" target="_blank" title="<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
" style="text-decoration: none;">
