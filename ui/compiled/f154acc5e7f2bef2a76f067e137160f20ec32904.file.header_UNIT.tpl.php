<?php /* Smarty version Smarty-3.1.13, created on 2023-12-04 09:14:58
         compiled from "ui\theme\softhash\sections\header_UNIT.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9611123063354cdc27a8f1-20073995%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f154acc5e7f2bef2a76f067e137160f20ec32904' => 
    array (
      0 => 'ui\\theme\\softhash\\sections\\header_UNIT.tpl',
      1 => 1701656092,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9611123063354cdc27a8f1-20073995',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_63354cdc31ec92_58789603',
  'variables' => 
  array (
    '_title' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_63354cdc31ec92_58789603')) {function content_63354cdc31ec92_58789603($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
penerimaan/list/">Penerimaan Unit</a></li>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='historypenerimaan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
penerimaan/history/">History Penerimaan</a></li>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='listmutasi'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
mutasi/list/">Mutasi Mobil</a></li> 
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='listbatalkonfirmasimutasi'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
mutasi/list-batal-konfirmasi-mutasi/">Batal Konfirmasi Mutasi</a></li>   
                    ...
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='reports'){?>mm-active<?php }?>">
						...
						<ul class="nav-second-level">
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='laporangudang'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
laporan/gudang/">Laporan Stock Gudang</a></li> 
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='laporanintransit'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
laporan/intransit/">Laporan Stock Intransit</a></li> 
						</ul>
					</li>
                </ul>
            </div>
