<?php /* Smarty version Smarty-3.1.13, created on 2025-07-21 09:57:28
         compiled from "ui\theme\softhash\sections\header_GAS.tpl" */ ?>
<?php /*%%SmartyHeaderCode:986842576374fd13f348b2-56594032%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '09d8dca09be54f3fdb825694303422e5b92d3c62' => 
    array (
      0 => 'ui\\theme\\softhash\\sections\\header_GAS.tpl',
      1 => 1753066638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '986842576374fd13f348b2-56594032',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_6374fd1408cc36_11574060',
  'variables' => 
  array (
    '_title' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_6374fd1408cc36_11574060')) {function content_6374fd1408cc36_11574060($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
/"><i class="fa fa-th-large"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Dashboard'];?>
                    ...
                    <?php if (_auth2('SHOW-MASTERDATA-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='data'){?>mm-active<?php }?>">
                        ...
                        <ul class="nav-second-level">
                            <?php if (_auth2('SHOW-JENIS-USAHA',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='jenisusaha'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
jenisusaha/list/">Jenis Usaha </a></li>
							<?php }?>
...
supplier/list/">Daftar Supplier </a></li>
							<?php }?>
							...
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='itemstock'){?>mm-active<?php }?>">
								...
								<ul class="nav-third-level">
									<!-- <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='listkategori'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
kategori/list/"><i class="fa fa-list"></i> Kategori Inventaris</a></li> -->
...
itemstock/list/">Daftar Barang </a></li>
...
itemstock/list-approve/"><i class="fa fa-check-square-o"></i> Daftar Persetujuan</a></li>
							...
							<?php }?>
							<?php if (_auth2('SHOW-DATA-INVENTARIS-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
inventaris/list-approve/"><i class="fa fa-check-square-o"></i> Daftar Persetujuan</a></li>
							...
							<?php if (_auth2('SHOW-INVENTARIS-MOBIL',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='listinventarismobil'){?>mm-active<?php }?>">
								<a href="#" class="has-arrow"><i class="fa fa-th-list"></i> Inventaris Mobil</a>
								<ul class="nav-third-level">
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='listinventarismobil'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
inventaris/list-mobil/"><i class="fa fa-car"></i> Mobil Inventaris</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='jenisservice'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
jenisservice/list/"><i class="fa fa-cogs"></i> Jenis Service</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='listbengkel'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
bengkel/list/"><i class="fa fa-dashboard"></i> Daftar Bengkel</a></li>    
								</ul>
							</li> -->
                            <?php }?>
...
permintaanbarang/list-mintabarang/">List UR</a></li>
                        <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Buat UR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/add-mintabarang/">Buat UR</a></li> 
                            <?php if (_auth2('SHOW-DEPT-UR',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Departemen UR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/list-mintabarang-departemen/">Departemen UR</a></li>
                            <?php }?>
                            <?php if (_auth2('SHOW-SERVICEHEAD-UR',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Service Head UR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/list-mintabarang-servicehead/">Service Head UR</a></li>
                            <?php }?>
                            <?php if (_auth2('SHOW-GAADMIN-UR',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='GA Admin UR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/list-mintabarang-gaadmin/">GA Admin UR</a></li>
                            <?php }?>
...
permintaanbarang/list-mintabarang-pending/">UR Pending</a></li>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='UR Approved'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/list-mintabarang-approved/">UR Approved</a></li>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='UR Reject'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/list-mintabarang-rejected/">UR Rejected</a></li>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='UR Cancel'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaanbarang/list-mintabarang-cancelled/">UR Cancelled</a></li> -->
						</ul>
					</li>
					

                    <?php if (_auth2('SHOW-PR',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
					<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='Permintaan'){?>mm-active<?php }?>">
						...
						<ul class="nav-second-level">
                            <?php if (_auth2('ADD-PR',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Buat PR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaan/add-pr/">Buat PR</a></li>
                            <?php }?>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='List PR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
permintaan/list-pr/">List PR</a></li>
						</ul>
					</li>
					<?php }?>

                    <?php if (_auth2('SHOW-PO',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
					<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='Purchase Order'){?>mm-active<?php }?>">
						<a class="has-arrow" href="#"><i class="fa fa-shopping-cart"></i> <span class="nav-label">Purchase Order </span></a>
						<ul class="nav-second-level">
                            <?php if (_auth2('ADD-PO',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Buat PO'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
pembelian/add-po/">Buat PO</a></li>
                            <?php }?>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='List PO'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
pembelian/list-po/">List PO</a></li>
						</ul>
					</li>
					<?php }?>

                    <!-- <?php if (_auth2('SHOW-TRANSAKSI-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='transaksi'){?>mm-active<?php }?>">
                        ...
                        <ul class="nav-second-level">
                            <?php if (_auth2('SHOW-PERMINTAAN-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
pembelian/list-pr-reject/">PR REJECTED</a></li>
                            ...
                            <?php }?>
                            <?php if (_auth2('SHOW-PEMBELIAN-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
pembelian/list-po-cancel/" style="padding-left: 67px;">PO CANCELED</a></li>-->
				            ...
				            <?php }?> -->
				            <!-- <?php if (_auth2('SHOW-PEMBELIAN-PERSETUJUAN-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
inventaris/mutasi/"><i class="fa fa-car"></i> Mutasi Mobil Inventaris</a></li>
					...
					<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='Persetujuan'){?>mm-active<?php }?>">
						<a class="has-arrow" href="#"><i class="fa fa-check-square-o"></i> <span class="nav-label">Persetujuan</a>
						<ul class="nav-second-level">
                            
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Persetujuan UR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
persetujuan/persetujuan-ur/">Persetujuan UR</a></li>
                            
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Penerimaan UR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
persetujuan/penerimaan-ur/">Penerimaan UR</a></li>
                           
                                <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='Persetujuan PR'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
persetujuan/persetujuan-pr/">Persetujuan PR</a></li>
                            
					</li>
					

                    <?php if (_auth2('SHOW-DISTRIBUSI-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
					<!-- <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='distribusi'){?>mm-active<?php }?>">
						...
						<ul class="nav-second-level">
                            <?php if (_auth2('SHOW-PENGIRIMAN-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                            <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='pengiriman'){?>mm-active<?php }?>">
                                <a href="#" class="has-arrow">Pengiriman</a>
								<ul class="nav-third-level">
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='addpengiriman'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
pengiriman/add/">Add SPBI</a></li>
...
pengiriman/list/">List SPBI</a></li>
                            ...
                            <?php }?>
                            <?php if (_auth2('SHOW-PENERIMAAN-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
penerimaan/list/">List BPnB</a></li>
					...
					<?php }?>
					<?php if (_auth2('SHOW-LAPORAN-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
					<!-- <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='reports'){?>mm-active<?php }?>">
						...
						<ul class="nav-second-level">
                            <?php if (_auth2('SHOW-LAPORAN-PR-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
laporan/pr/">Laporan PR</a></li> 
                            <?php }?>
                            <?php if (_auth2('SHOW-LAPORAN-PEMENUHAN-PR-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
...
laporan/pemenuhanpr/">Laporan Pemenuhan PR</a></li> 
                            <?php }?>
                            <?php if (_auth2('SHOW-LAPORAN-PO-GAS',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
