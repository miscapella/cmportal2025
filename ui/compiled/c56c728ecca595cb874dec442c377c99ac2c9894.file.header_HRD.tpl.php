<?php /* Smarty version Smarty-3.1.13, created on 2025-07-22 08:16:08
         compiled from "ui\theme\softhash\sections\header_HRD.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1078102931665eb6701cdef3-06750900%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c56c728ecca595cb874dec442c377c99ac2c9894' => 
    array (
      0 => 'ui\\theme\\softhash\\sections\\header_HRD.tpl',
      1 => 1753146967,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1078102931665eb6701cdef3-06750900',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_665eb67025b253_73812583',
  'variables' => 
  array (
    '_title' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_665eb67025b253_73812583')) {function content_665eb67025b253_73812583($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
/"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboard</span></a></li>
                    ...
                    <?php if (_auth2('SHOW-MASTERDATA-KARYAWAN',$_smarty_tpl->tpl_vars['user']->value['id'])||_auth2('SHOW-MASTERDATA-POSISI',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='masterdata'){?>mm-active<?php }?>">
                        ...
                        <ul class="nav-second-level">
							...
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='karyawan-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
karyawan/list/">List Karyawan</a></li>
                            <?php }?>
                            <?php if (_auth2('SHOW-MASTERDATA-POSISI',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='posisi-list'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
posisi/list/">List Posisi</a></li>
                            <?php }?>
...
cabang/list/">List Cabang</a></li>
                    ...
                    <?php if (_auth2('SHOW-GRAFIK-KARYAWAN',$_smarty_tpl->tpl_vars['user']->value['id'])||_auth2('SHOW-PRODUKTIVITAS-BENGKEL',$_smarty_tpl->tpl_vars['user']->value['id'])||_auth2('SHOW-PRODUKTIVITAS-MARKETING',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu']->value=='analisis'){?>mm-active<?php }?>">
                        ...
                        <ul class="nav-second-level">
                            <?php if (_auth2('SHOW-GRAFIK-KARYAWAN',$_smarty_tpl->tpl_vars['user']->value['id'])){?>
							<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu1']->value=='grafik-karyawan'){?>mm-active<?php }?>">
								<a href="#" class="has-arrow">Grafik Karyawan</a>
								<ul class="nav-third-level">
                                    <li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='profil-distribusi-karyawan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
grafik-karyawan/profil-distribusi-karyawan/">Profil Distribusi Karyawan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='rekapitulasi-cuti-karyawan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
grafik-karyawan/rekapitulasi-cuti-karyawan/">Rekapitulasi Cuti Karyawan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='demografi-karyawan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
grafik-karyawan/demografi-karyawan/">Demografi Karyawan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='status-karyawan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
grafik-karyawan/status-karyawan/">Status Karyawan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='pendidikan-karyawan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
grafik-karyawan/pendidikan-karyawan/">Pendidikan Karyawan</a></li>
									<li class="<?php if ($_smarty_tpl->tpl_vars['_sysfrm_menu2']->value=='terminated-karyawan'){?>mm-active<?php }?>"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
grafik-karyawan/terminated-karyawan/">Terminated Karyawan</a></li>
...
grafik-karyawan/bpjs-kesehatan/">BPJS Kesehatan</a></li>
								</ul>
							</li>
                            <?php }?>
