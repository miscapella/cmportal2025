<?php /* Smarty version Smarty-3.1.13, created on 2024-02-26 14:32:48
         compiled from "ui\theme\softhash\prog\GAS\add-pr-supplier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:49128892564102fb4092e72-66979002%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acf729b4b4ceeb215a8c3fea80df356d0f70839e' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\GAS\\add-pr-supplier.tpl',
      1 => 1708932767,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '49128892564102fb4092e72-66979002',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_64102fb416c7d7_12753812',
  'variables' => 
  array (
    'msg' => 0,
    '_url' => 0,
...
<?php if ($_valid && !is_callable('content_64102fb416c7d7_12753812')) {function content_64102fb416c7d7_12753812($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("sections/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
/" class="btn btn-primary btn-sm">Daftar PR</a>
				</div>
...
?>
							<tr>
								...
								<td style="vertical-align: middle;"><input type="text" name="keperluan[]" class="keperluan" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keperluan']=='PENGADAAN' ? 'PENGADAAN BARU' : $_smarty_tpl->tpl_vars['ds']->value['keperluan'];?>
" readonly></td>
								<!-- <td style="vertical-align: middle;"><a href="#" class="keperluan"><?php echo $_smarty_tpl->tpl_vars['ds']->value['keperluan']=='PENGADAAN' ? 'PENGADAAN BARU' : $_smarty_tpl->tpl_vars['ds']->value['keperluan'];?>
</a></td> -->
								<td style="display: none;"><input type="text" name="kode_item[]" class="kode_item" readonly value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kd_item'];?>
"></td>
...
"><?php echo $_smarty_tpl->tpl_vars['nama_line']->value;?>
								...
								<td style="display:none;"><input type="text" name="item[]" class="item" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kd_item'];?>
" readonly></td>
...
?>
									<?php if ($_smarty_tpl->tpl_vars['ds']->value['kd_item']==$_smarty_tpl->tpl_vars['r1']->value['kd_item']){?>
										<?php $_smarty_tpl->tpl_vars["nama_item"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['r1']->value['nm_item']), null, 0);?>
									<?php }?>
								<?php } ?>
								<td style="vertical-align: middle;"><a href="#" class="detail-itemstock" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kd_item'];?>
...
?>
									        <?php if ($_smarty_tpl->tpl_vars['r4']->value['kd_item']==$_smarty_tpl->tpl_vars['ds']->value['kd_item']){?>
									            <option value="<?php echo $_smarty_tpl->tpl_vars['r4']->value['kd_supplier'];?>
" <?php if ($_smarty_tpl->tpl_vars['r4']->value['kd_supplier']==$_smarty_tpl->tpl_vars['ds']->value['kd_supplier1']){?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['r4']->value['kd_supplier'];?>
...
file_supplier1" name="sfile_supplier1[]" class="files"><input type="text" id="<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier1" name="file_supplier1[]" style="display: none;"></td>
								<td style="vertical-align: middle;">
...
$_smarty_tpl->tpl_vars['r4']->_loop = true;
?>
									        <?php if ($_smarty_tpl->tpl_vars['r4']->value['kode_item']==$_smarty_tpl->tpl_vars['ds']->value['kd_item']){?>
...
"></td>
								<td style="vertical-align: middle;"><input type="file" id="s<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier2" name="sfile_supplier2[]" class="files"><input type="text" id="<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier2" name="file_supplier2[]" style="display: none;"></td>
								<td style="vertical-align: middle;">
...
"></td>
								<td style="vertical-align: middle;"><input type="file" id="s<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier3" name="sfile_supplier3[]" class="files"><input type="text" id="<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier3" name="file_supplier3[]" style="display: none;"></td>
								<td style="vertical-align: middle;">
