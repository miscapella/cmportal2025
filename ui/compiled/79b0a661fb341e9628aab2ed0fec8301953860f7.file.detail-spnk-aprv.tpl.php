<?php /* Smarty version Smarty-3.1.13, created on 2023-10-25 10:25:47
         compiled from "ui\theme\softhash\prog\KEBUN\detail-spnk-aprv.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2775732416535fb55afe180-42940668%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '79b0a661fb341e9628aab2ed0fec8301953860f7' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\KEBUN\\detail-spnk-aprv.tpl',
      1 => 1698204346,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2775732416535fb55afe180-42940668',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_6535fb55b4ab78_55243923',
  'variables' => 
  array (
    'msg' => 0,
    'd' => 0,
...
<?php if ($_valid && !is_callable('content_6535fb55b4ab78_55243923')) {function content_6535fb55b4ab78_55243923($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("sections/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body <?php if ($_smarty_tpl->tpl_vars['d']->value['priority']=='URGENT'){?>red-bg<?php }else{ ?>blue-bg<?php }?>">
			    <div class="col-lg-6"><h3>DETAIL SURAT PERINTAH KERJA</h3></div>
			    <div class="col-lg-6" style="text-align: right"><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
pembelian/list-spnk-aprv/" class="btn btn-primary btn-sm">Back</a></div>
            </div>
        </div>
    </div>
</div>
...
" disabled></div>
				...
				<div class="form-group"><label class="col-lg-3 control-label" for="tgl_spmk">Tanggal SPnK</label>
...
" disabled></div>
				...
				<?php if ($_smarty_tpl->tpl_vars['d']->value['ktr_disetujui_nama']!=''){?>
				<div class="form-group"><label class="col-lg-3 control-label" for="ktr_disetujui">Kontraktor Disetujui Oleh</label>
					<div class="col-lg-5"><input type="text" id="ktr_disetujui" name="ktr_disetujui" class="form-control" value="<?php if ($_smarty_tpl->tpl_vars['d']->value['ktr_disetujui_nama']!=''){?><?php echo $_smarty_tpl->tpl_vars['d']->value['ktr_disetujui_nama'];?>
<?php }else{ ?>Menunggu Approval<?php }?>" disabled></div>
                    <label class="col-lg-2 control-label text-right" for="tglktr_disetujui">Tanggal Kontraktor Disetujui</label>
                    <div class="col-lg-2"><input type="text" id="tglktr_disetujui" name="tglktr_disetujui" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['ktr_disetujui_tgl'];?>
" datepicker data-date-format="dd-mm-yyyy" data-auto-close="true" disabled>
					</div>
				</div><br>
				<?php }?>
...
?>
                ...
                <?php } ?>
                <div class="form-group">
                    <div class="form-group col-lg-4 <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor1']){?> supplierpilihan <?php }?>" style="border-right: 1px solid #e7eaec;">
                        <div class="row">
                            <input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan[]" class="cekbox col-lg-12" <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor1']){?> checked <?php }?> value="kontraktor1" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="kontraktor1">Kontraktor 1</label><span class="col-lg-1" style="text-align: right">:</span>
                            <a href="#" class="col-lg-8 detail-kontraktor" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kontraktor1'];?>
"><?php echo $_smarty_tpl->tpl_vars['ds']->value['kontraktor1'];?>
</a>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="nama_kontraktor1">Nama</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="nama_kontraktor1" name="nama_kontraktor1" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['nama_kontraktor1']->value;?>
" disabled>
                        </div>
                        <div class="row">
...
" disabled>
                        ...
                        <div class="row">
                            <label class="col-lg-3 control-label" for="keterangan_kontraktor1">Keterangan</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8" type="text" id="keterangan_kontraktor1" name="keterangan_kontraktor1" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keterangan_kontraktor1'];?>
" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="file_kontraktor1">File</label><span class="col-lg-1" style="text-align: right">:</span><div class="col-lg-8">
                            <?php if ($_smarty_tpl->tpl_vars['ds']->value['file_kontraktor1']!=''){?>
                            <a href="uploads/KEBUN/<?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor1'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor1'];?>
</a>
                            <?php }?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-lg-4 <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor2']){?> supplierpilihan <?php }?>" style="border-right: 1px solid #e7eaec">
                        <div class="row">
                            <input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan[]" class="cekbox col-lg-12" <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor2']){?> checked <?php }?> value="kontraktor2" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="kontraktor2">Kontraktor 2</label><span class="col-lg-1" style="text-align: right">:</span>
                            <a href="#" class="col-lg-8 detail-kontraktor" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kontraktor2'];?>
"><?php echo $_smarty_tpl->tpl_vars['ds']->value['kontraktor2'];?>
</a>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="nama_kontraktor2">Nama</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="nama_kontraktor2" name="nama_kontraktor2" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['nama_kontraktor2']->value;?>
" disabled>
                        </div>
                        <div class="row">
...
" disabled>
                        ...
                        <div class="row">
                            <label class="col-lg-3 control-label" for="keterangan_kontraktor2">Keterangan</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8" type="text" id="keterangan_kontraktor2" name="keterangan_kontraktor2" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keterangan_kontraktor2'];?>
" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="file_kontraktor2">File</label><span class="col-lg-1" style="text-align: right">:</span><div class="col-lg-8">
                            <?php if ($_smarty_tpl->tpl_vars['ds']->value['file_kontraktor2']!=''){?>
                            <a href="uploads/KEBUN/<?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor2'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor2'];?>
</a>
                            <?php }?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-lg-4 <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor3']){?> supplierpilihan <?php }?>">
                        <div class="row">
                            <input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan[]" class="cekbox col-lg-12" <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor3']){?> checked <?php }?> value="kontraktor3" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="kontraktor3">Kontraktor 3</label><span class="col-lg-1" style="text-align: right">:</span>
                            <a href="#" class="col-lg-8 detail-kontraktor" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['kontraktor3'];?>
"><?php echo $_smarty_tpl->tpl_vars['ds']->value['kontraktor3'];?>
</a>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="nama_kontraktor3">Nama</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8 " type="text" id="nama_kontraktor3" name="nama_kontraktor3" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['nama_kontraktor3']->value;?>
" disabled>
                        </div>
                        <div class="row">
...
" disabled>
                        ...
                        <div class="row">
                            <label class="col-lg-3 control-label" for="keterangan_kontraktor3">Keterangan</label><span class="col-lg-1" style="text-align: right">:</span>
                            <input class="col-lg-8" type="text" id="keterangan_kontraktor3" name="keterangan_kontraktor3" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keterangan_kontraktor3'];?>
" disabled>
                        </div>
                        <div class="row">
                            <label class="col-lg-3 control-label" for="file_kontraktor3">File</label><span class="col-lg-1" style="text-align: right">:</span><div class="col-lg-8">
                            <?php if ($_smarty_tpl->tpl_vars['ds']->value['file_kontraktor3']!=''){?>
                            <a href="uploads/KEBUN/<?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor3'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor3'];?>
</a>
                            <?php }?>
                            </div>
                        </div>
