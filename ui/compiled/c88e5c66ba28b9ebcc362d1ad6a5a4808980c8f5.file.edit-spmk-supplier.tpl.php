<?php /* Smarty version Smarty-3.1.13, created on 2024-06-12 08:57:25
         compiled from "ui\theme\softhash\prog\KEBUN\edit-spmk-supplier.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15413672246646c7a40cae37-90249519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c88e5c66ba28b9ebcc362d1ad6a5a4808980c8f5' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\KEBUN\\edit-spmk-supplier.tpl',
      1 => 1718157442,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15413672246646c7a40cae37-90249519',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_6646c7a419dd58_04309807',
  'variables' => 
  array (
    'msg' => 0,
    '_url' => 0,
...
<?php if ($_valid && !is_callable('content_6646c7a419dd58_04309807')) {function content_6646c7a419dd58_04309807($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("sections/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
pembelian/list-spmk-reject/" class="btn btn-primary btn-sm">Daftar SPMK</a>
				</div>
...
<div class="row">
	<div class="col-md-12">
        ...
        <div class="ibox-content" id="ibox_form">
          <div class="form-group"><label class="col-lg-3 control-label" for="no_pr">No. SPMK</label>
            <div class="col-lg-9"><input type="text" id="no_pr" name="no_pr" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['no_spmk'];?>
" disabled></div>
          </div><br>
...
?>
							<tr>
								...
								<td style="vertical-align: middle;"><input type="text" name="keperluan[]" class="keperluan" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['spesifikasi'];?>
" readonly></td>
								<td style="display: none;"><input type="text" name="kode_item[]" class="kode_item" readonly value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['block'];?>
"></td>
...
?>
									...
									<?php }?>
								<?php } ?>
								<td style="vertical-align: middle;"><input type="text" name="block[]" class="" value=<?php echo $_smarty_tpl->tpl_vars['ds']->value['block'];?>
 readonly></td>
								<td style="vertical-align: middle;"><input type="text" name="ha[]" class="qty amount" value=<?php echo $_smarty_tpl->tpl_vars['ds']->value['ha'];?>
 readonly></td>
								<td style="vertical-align: middle;"><input type="text" name="pkk[]" class="qty amount" value=<?php echo $_smarty_tpl->tpl_vars['ds']->value['pkk'];?>
 readonly></td>
...
"></td>
								<td style="vertical-align: middle;"><input type="text" name="keterangan_supplier1[]" class="keterangan" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keterangan_kontraktor1'];?>
"></td>
								<td style="vertical-align: middle;">
...
file_supplier1" name="file_supplier1[]" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor1'];?>
" style="display: none;">
...
" ></td>
								<td style="vertical-align: middle;"><input type="text" name="keterangan_supplier2[]" class="keterangan" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keterangan_kontraktor2'];?>
"></td>
								<td style="vertical-align: middle;">
									<input type="file" id="s<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier2" name="sfile_supplier2[]" class="files">
									<input type="text" id="<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier2" name="file_supplier2[]" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor2'];?>
" style="display: none;">
...
"></td>
								<td style="vertical-align: middle;"><input type="text" name="keterangan_supplier3[]" class="keterangan" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keterangan_kontraktor3'];?>
"></td>
								<td style="vertical-align: middle;">
									<input type="file" id="s<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier3" name="sfile_supplier3[]" class="files">
									<input type="text" id="<?php echo $_smarty_tpl->tpl_vars['nourut']->value;?>
file_supplier3" name="file_supplier3[]" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['file_kontraktor3'];?>
" style="display: none;">
...
kontraktorpilihan1[]" class="cekbox" value="supplier1" <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor1']&&$_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']!=''){?> checked <?php }?>> <label style="font-weight: normal" for="<?php echo $_smarty_tpl->tpl_vars['ds']->value["keperluan"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["kode_item"];?>
supplierpilihan1[]"> Supplier 1</label><br>
									<input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan[]" id="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan2[]" class="cekbox" value="supplier2" <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor2']&&$_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']!=''){?> checked <?php }?>> <label style="font-weight: normal" for="<?php echo $_smarty_tpl->tpl_vars['ds']->value["keperluan"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["kode_item"];?>
supplierpilihan2[]"> Supplier 2</label><br>
									<input type="radio" name="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan[]" id="<?php echo $_smarty_tpl->tpl_vars['ds']->value["id"];?>
kontraktorpilihan3[]" class="cekbox" value="supplier3" <?php if ($_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']==$_smarty_tpl->tpl_vars['ds']->value['kontraktor3']&&$_smarty_tpl->tpl_vars['ds']->value['kontraktorpilihan']!=''){?> checked <?php }?>> <label style="font-weight: normal" for="<?php echo $_smarty_tpl->tpl_vars['ds']->value["keperluan"];?>
<?php echo $_smarty_tpl->tpl_vars['ds']->value["kode_item"];?>
