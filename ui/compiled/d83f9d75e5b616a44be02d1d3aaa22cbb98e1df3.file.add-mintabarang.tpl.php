<?php /* Smarty version Smarty-3.1.13, created on 2024-09-05 15:53:15
         compiled from "ui\theme\softhash\prog\GAS\add-mintabarang.tpl" */ ?>
<?php /*%%SmartyHeaderCode:208066842865e19ea8c5e324-59751554%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd83f9d75e5b616a44be02d1d3aaa22cbb98e1df3' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\GAS\\add-mintabarang.tpl',
      1 => 1725526394,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '208066842865e19ea8c5e324-59751554',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_65e19ea8cbf8f4_02575559',
  'variables' => 
  array (
    'event_mrs' => 0,
    'id' => 0,
...
<?php if ($_valid && !is_callable('content_65e19ea8cbf8f4_02575559')) {function content_65e19ea8cbf8f4_02575559($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("sections/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
		...
		<div class="modal-body">
		  <form class="form-horizontal" id="rform" autocomplete="off" spellcheck="false">
			...
			<div class="form-group">
				...
				<input name="qtyModal" type="number" class="form-control amount" id="qtyModal" value="0" min="0" step="1">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="keteranganModal" class="col-form-label">KETERANGAN PERMINTAAN <span style="color: red;">*</span></label>
...
permintaanbarang/list-mintabarang/" class="btn btn-primary btn-xs">Daftar User Request</a>
				</div>
			</div>
			<div class="panel-body">
				<!-- <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-lg-3"><input style="background-color: #f7f7f7;" type="text" id="tgl" name="tgl" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['idate']->value;?>
