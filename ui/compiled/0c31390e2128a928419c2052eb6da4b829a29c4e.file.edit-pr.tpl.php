<?php /* Smarty version Smarty-3.1.13, created on 2023-08-31 14:36:35
         compiled from "ui\theme\softhash\prog\KEBUN\edit-pr.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62628310864f042ddb11840-23375584%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0c31390e2128a928419c2052eb6da4b829a29c4e' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\KEBUN\\edit-pr.tpl',
      1 => 1693467393,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '62628310864f042ddb11840-23375584',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_64f042ddb70b37_85812498',
  'variables' => 
  array (
    'clist' => 0,
    'msg' => 0,
...
<?php if ($_valid && !is_callable('content_64f042ddb70b37_85812498')) {function content_64f042ddb70b37_85812498($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("sections/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="form-group"><label class="col-lg-3 control-label" for="no_pr">No. PR</label>
					<div class="col-lg-3"><input type="text" id="no_pr" name="no_pr" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['no_pr'];?>
" readonly></div>
				</div><br>
				<div class="form-group"><label class="col-lg-3 control-label" for="no_pr_fisik">No. PR Fisik</label>
					<div class="col-lg-3"><input type="text" id="no_pr_fisik" name="no_pr_fisik" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['no_pr_fisik'];?>
" readonly></div>
				</div><br>
