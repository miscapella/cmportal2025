<?php /* Smarty version Smarty-3.1.13, created on 2023-08-22 10:29:41
         compiled from "ui\theme\softhash\prog\KEBUN\detail-pr-aprv.tpl" */ ?>
<?php /*%%SmartyHeaderCode:83918996264c09b21a23ac3-91998264%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b89b154096d6d0c01c2b3f8c5c7525f68dca1172' => 
    array (
      0 => 'ui\\theme\\softhash\\prog\\KEBUN\\detail-pr-aprv.tpl',
      1 => 1692674977,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '83918996264c09b21a23ac3-91998264',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_64c09b21b74fc2_52407605',
  'variables' => 
  array (
    'msg' => 0,
    'd' => 0,
...
<?php if ($_valid && !is_callable('content_64c09b21b74fc2_52407605')) {function content_64c09b21b74fc2_52407605($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("sections/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
?>
                ...
                <div class="form-group" ><label class="col-lg-2 control-label" for="keperluan1">Keperluan</label><span class="col-lg-1" style="text-align: right">:</span>
					<input class="col-lg-9" type="text" id="keperluan1" name="keperluan1" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['ds']->value['keperluan'];?>
" disabled>
				</div><br>
...
"><?php echo $_smarty_tpl->tpl_vars['nama_item']->value;?>
                ...
                <div class="form-group" ><label class="col-lg-2 control-label" for="qty_req1">Qty Req</label><span class="col-lg-1" style="text-align: right">:</span>
					<div class="col-lg-9" type="text" id="qty_req1" name="qty_req1" class="form-control"><span class="amount"><?php echo $_smarty_tpl->tpl_vars['ds']->value['qty_req'];?>
</span> <?php echo $_smarty_tpl->tpl_vars['satuan']->value;?>
</div>
				</div><br>
                <?php $_smarty_tpl->tpl_vars['tglSplit'] = new Smarty_variable(explode("-",$_smarty_tpl->tpl_vars['ds']->value['tgl_diperlukan']), null, 0);?>
                <div class="form-group" ><label class="col-lg-2 control-label" for="tgl_diperlukan1">Tgl Diperlukan</label><span class="col-lg-1" style="text-align: right">:</span>
					<input class="col-lg-9" type="text" id="tgl_diperlukan1" name="tgl_diperlukan1" value="<?php echo $_smarty_tpl->tpl_vars['tglSplit']->value[2];?>
-<?php echo $_smarty_tpl->tpl_vars['tglSplit']->value[1];?>
-<?php echo $_smarty_tpl->tpl_vars['tglSplit']->value[0];?>
" disabled>
				</div><br>
