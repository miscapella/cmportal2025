...
$ui->assign('_sysfrm_menu2', 'listbengkel');
$ui->assign('_title', 'Daftar Bengkel - '. $config['CompanyName']);
$ui->assign('_st', 'Daftar Bengkel');
...
//');
 ...
 // ');
        ...
        $ui->display($spath.'add-bengkel.tpl');
...
//check account is already exist
    ...
    case 'list':
        ...
        Event::trigger('bengkel/listbengkel/');

		_auth1('WORKSHOP-LIST',$user['id']);
            $name = _post('name');
        $ui->assign('name',$name);
        if($name != ''){
        ...
        $ui->assign('xfooter', Asset::js(array($spath.'list-bengkel')));
        $ui->assign('jsvar', '
_L[\'are_you_sure\'] = \''.$_L['are_you_sure'].'\';
 ');
        $ui->display($spath.'list-bengkel.tpl');
